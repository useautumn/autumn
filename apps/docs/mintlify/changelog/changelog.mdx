...
<Update label="September 11th 2026">
  ...
  <AccordionGroup>
    <Accordion title="Improvements">
      ...
      - The OAuth allowlist now includes `customers:write`, `features:write`, `plans:write`, and `apiKeys:write`, so `atmn` v3 login no longer fails with `invalid_scope` — [#3354](https://github.com/useautumn/autumn/pull/3354)
