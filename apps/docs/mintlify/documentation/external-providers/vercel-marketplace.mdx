...
Autumn lets you add your product to [Vercel's Marketplace](https://vercel.com/marketplace) without any additional code. This guide walks through connecting the Autumn partner API and webhooks to Vercel.

Vercel-billed subscriptions run in Stripe **invoice mode** — Vercel collects payment from the end customer, and Autumn marks the corresponding Stripe invoice paid out of band. No Stripe custom payment method setup is required.
