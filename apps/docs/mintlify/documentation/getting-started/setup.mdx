...
<Info>
Autumn's client-side [hooks](/react/hooks/useCustomer) allow you to handle billing directly from your frontend. They are supported for apps with a TypeScript frontend and backend.
</Info>
