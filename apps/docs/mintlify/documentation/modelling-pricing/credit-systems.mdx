...
A graduated row steps the credit cost as usage in the current cycle grows. Usage is priced tier by tier: below, the first 10,000 units cost 1 credit each and everything after costs 0.5.
