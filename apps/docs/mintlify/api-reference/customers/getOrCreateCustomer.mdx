  ...
  <Expandable title="properties">
    ...
    <DynamicParamField body="usage_limits" type="object[]">
      ...
      <Expandable title="properties">
        ...
        <DynamicParamField body="anchor" type="'billing_cycle' | 'utc'">
    ...
    <DynamicParamField body="usage_alerts" type="object[]">
      ...
      <Expandable title="properties">
        ...
        <DynamicParamField body="basis" type="'balance' | 'included' | 'recurring' | 'usage_limit'">
...
<DynamicParamField body="billing_details" type="object">
  Billing details to set on the Stripe customer. Creates the Stripe customer if needed.
  <Expandable title="properties">
    <DynamicParamField body="address" type="object | null">
      Billing address, used for tax and shown on invoices. Replaces the whole address, as in Stripe; null clears it.
      <Expandable title="properties">
        <DynamicParamField body="line1" type="string | null" />

        <DynamicParamField body="line2" type="string | null" />

        <DynamicParamField body="city" type="string | null" />

        <DynamicParamField body="state" type="string | null" />

        <DynamicParamField body="postal_code" type="string | null" />

        <DynamicParamField body="country" type="string | null">
    ...
    <DynamicParamField body="tax_ids" type="object">
      ...
      <Expandable title="properties">
        <DynamicParamField body="add" type="object[]">
        ...
        <DynamicParamField body="remove" type="object[]">
    ...
    <DynamicParamField body="tax_exempt" type="'none' | 'exempt' | 'reverse'">
      Tax exemption status. Use reverse for reverse-charge customers.
    </DynamicParamField>

    <DynamicParamField body="invoice_settings" type="object">
      <Expandable title="properties">
        <DynamicParamField body="custom_fields" type="object[] | null">
...
<DynamicParamField body="expand" type="('invoices' | 'invoice_previews' | 'trials_used' | 'rewards' | 'entities' | 'referrals' | 'payment_method' | 'billing_details' | 'subscriptions.plan' | 'purchases.plan' | 'balances.feature' | 'flags.feature' | 'billing_controls.auto_topups.purchase_limit')[]">
    ...
    <DynamicResponseField name="plan" type="object">
      ...
      <Expandable title="properties">
        ...
        <DynamicResponseField name="items" type="object[]">
          ...
          <Expandable title="properties">
            <DynamicResponseField name="threshold_billing" type="object | null">
            ...
            <DynamicResponseField name="expiry" type="object | null">
              ...
              <Expandable title="properties">
                <DynamicResponseField name="duration" type="'day' | 'week' | 'month' | 'year'" />
              ...
              <Expandable title="properties">
                ...
                <DynamicResponseField name="add_items" type="object[]">
                  ...
                  <Expandable title="properties">
                    ...
                    <DynamicResponseField name="expiry" type="object">
                      Purchased units expire this long after each purchase. One-off prepaid consumable items only.
                      <Expandable title="properties">
                        <DynamicResponseField name="duration" type="'day' | 'week' | 'month' | 'year'" />
...
<DynamicResponseField name="billing_details" type="object | null">
  Billing details read live from the linked Stripe customer. Null when no Stripe customer is linked.
  <Expandable title="properties">
    <DynamicResponseField name="address" type="object | null">
      <Expandable title="properties">
        <DynamicResponseField name="line1" type="string | null" />

        <DynamicResponseField name="line2" type="string | null" />

        <DynamicResponseField name="city" type="string | null" />

        <DynamicResponseField name="state" type="string | null" />

        <DynamicResponseField name="postal_code" type="string | null" />

        <DynamicResponseField name="country" type="string | null">
          Two-letter country code (ISO 3166-1 alpha-2).
        </DynamicResponseField>
    ...
    <DynamicResponseField name="tax_ids" type="object[]">
      <Expandable title="properties">
        <DynamicResponseField name="type" type="string">
          Stripe tax ID type, e.g. eu_vat, gb_vat, us_ein. See https://docs.stripe.com/billing/customer/tax-ids#supported-tax-id
        </DynamicResponseField>

        <DynamicResponseField name="value" type="string">
          The tax ID, e.g. DE123456789.
        </DynamicResponseField>
    ...
    <DynamicResponseField name="tax_exempt" type="'none' | 'exempt' | 'reverse'" />

    <DynamicResponseField name="invoice_settings" type="object">
      <Expandable title="properties">
        <DynamicResponseField name="custom_fields" type="object[]">
          <Expandable title="properties">
            <DynamicResponseField name="name" type="string">
              Label, e.g. PO Number.
            </DynamicResponseField>
