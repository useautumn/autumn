...
<DynamicParamField body="billing_controls" type="object">
  <Expandable title="properties">
    ...
    <DynamicParamField body="usage_limits" type="object | object[]">
      ...
      <Expandable title="properties">
        ...
        <DynamicParamField body="limit" type="number">
          Maximum units allowed per interval.
        </DynamicParamField>

        <DynamicParamField body="interval" type="'day' | 'week' | 'month' | 'year'">
        ...
        <DynamicParamField body="source" type="'customer' | 'plan'">
