...
<ParamField body="reason" type="'charge_failed' | 'purchase_limit_reached' | 'attempt_limit_reached' | 'failed_attempt_limit_reached' | 'suspended_after_failures' | 'customer_unavailable' | 'configuration_unavailable' | 'missing_payment_method' | 'missing_customer_product' | 'invalid_amount' | 'grant_limit_reached' | 'lock_contention' | 'redis_unavailable' | 'execution_error'" required>
