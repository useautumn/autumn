        ...
        <ParamField body="plan" type="object">
          ...
          <Expandable title="properties">
            ...
            <ParamField body="items" type="object[]" required>
              ...
              <Expandable title="properties">
                <ParamField body="threshold_billing" type="object | null">
                ...
                <ParamField body="expiry" type="object | null">
                  Purchased units expire this long after each purchase. One-off prepaid consumable items only.
                  <Expandable title="properties">
                    <ParamField body="duration" type="'day' | 'week' | 'month' | 'year'" required />
                  ...
                  <Expandable title="properties">
                    ...
                    <ParamField body="add_items" type="object[]">
                      ...
                      <Expandable title="properties">
                        ...
                        <ParamField body="expiry" type="object">
                          Purchased units expire this long after each purchase. One-off prepaid consumable items only.
                          <Expandable title="properties">
                            <ParamField body="duration" type="'day' | 'week' | 'month' | 'year'" required />
