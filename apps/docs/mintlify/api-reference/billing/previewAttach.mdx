...
<DynamicParamField body="remove_plan_ids" type="string[]">
...
<DynamicParamField body="remove_discounts" type="object[]">
...
<DynamicResponseField name="resets_usage" type="boolean">
