...
<DynamicParamField body="items" type="object[]">
  ...
  <Expandable title="properties">
    <DynamicParamField body="threshold_billing" type="object | null">
    ...
    <DynamicParamField body="expiry" type="object">
      Purchased units expire this long after each purchase. One-off prepaid consumable items only.
      <Expandable title="properties">
        <DynamicParamField body="duration" type="'day' | 'week' | 'month' | 'year'" required />
    ...
    <DynamicParamField body="feature_override" type="object">
      ...
      <Expandable title="properties">
        ...
        <DynamicParamField body="markups" type="object">
  ...
  <Expandable title="properties">
    ...
    <DynamicParamField body="customize" type="object" required>
      ...
      <Expandable title="properties">
        ...
        <DynamicParamField body="remove_licenses" type="object[]">
