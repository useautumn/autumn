...
<DynamicParamField body="licenses" type="object[]">
  ...
  <Expandable title="properties">
    ...
    <DynamicParamField body="version_slug" type="string" />
              ...
              <Expandable title="properties">
                <DynamicParamField body="credit_schema" type="object | object[]">
                  ...
                  <Expandable title="properties">
                    ...
                    <DynamicParamField body="tiers" type="any[]" />
...
<DynamicParamField body="base_plan_id" type="string | null">
...
<DynamicParamField body="migration" type="object">
  <Expandable title="properties">
    <DynamicParamField body="draft" type="boolean" />

    <DynamicParamField body="include_custom" type="boolean" />

  </Expandable>
</DynamicParamField>

<DynamicParamField body="force_version" type="boolean">
...
<DynamicParamField body="variants" type="object[]">
  ...
  <Expandable title="properties">
    <DynamicParamField body="variant_plan_id" type="string" required>
    ...
    <DynamicParamField body="customize" type="object" required>
            ...
            <DynamicParamField body="feature_override" type="object">
              ...
              <Expandable title="properties">
                <DynamicParamField body="credit_schema" type="object | object[]">
                  For credit system features: replaces the feature's credit_schema entirely for customers on this plan.
                  <Expandable title="properties">
                    <DynamicParamField body="metered_feature_id" type="any" />

                    <DynamicParamField body="billing_units" type="any" />

                    <DynamicParamField body="tier_behavior" type="any" />

                    <DynamicParamField body="tiers" type="any" />

                    <DynamicParamField body="credit_cost" type="any" />
            ...
            <DynamicParamField body="usage_limits" type="object[]">
              ...
              <Expandable title="properties">
                ...
                <DynamicParamField body="filter" type="object">
                  When set, only usage from events whose properties match counts toward this cap. Omit to count all usage of the feature.
                  <Expandable title="properties">
                    <DynamicParamField body="properties.{key}" type="any" required />
...
<DynamicParamField body="is_default" type="boolean">
