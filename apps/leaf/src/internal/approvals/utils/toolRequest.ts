 ...
 * shapes pass the fields flat, so both have to be accepted. Falls back to `args`
 * itself, so a defined input always yields a defined body. */
export function toolRequestFromArgs(
	args: Record<string, unknown>,
): Record<string, unknown>;
export function toolRequestFromArgs(
	args?: Record<string, unknown>,
): Record<string, unknown> | undefined;
export function toolRequestFromArgs(args?: Record<string, unknown>) {
