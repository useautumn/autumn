						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 relative z-60 gap-8 lg:gap-0">
							{plans.map((plan, index) => (
								<div
									key={plan.name}
									className={cn(
										"relative flex flex-col border border-[#292929] bg-black lg:border-0 lg:bg-transparent",
										(index === 0 || index === 1) && "lg:border-r",
										index === 2 &&
											"md:col-span-2 md:w-[calc(50%-16px)] md:justify-self-center lg:col-span-1 lg:w-full lg:justify-self-auto",
									)}
								>
									{plan.isPro && (
