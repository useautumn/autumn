...
const images: Record<SidebarItem["model"], string> = {
	...
	return (
		<section className="bg-[#000000] w-full overflow-hidden flex flex-col">
			...
			<div className="border-t-0 lg:border-t border-[#292929] w-full relative grid grid-cols-1 lg:grid-cols-[60px_220px_220px_1fr] xl:grid-cols-[90px_291px_300px_1fr] auto-rows-auto lg:grid-rows-[260px_340px]">
				...
				<div className="border-r border-[#292929] flex flex-col py-0 lg:py-[32px] z-10 relative bg-[#000000]">
						...
						{sidebarItems.map((item) => {
							...
							return (
								<li
									key={item.id}
									className={cn(
										"flex flex-col transition-colors border-b border-[#292929] last:border-b-0 lg:border-none",
								...
								>
									...
									<button
										...
										className={cn(
											"flex w-full cursor-pointer items-center gap-2 bg-transparent px-6 py-5 text-left font-sans text-[20px] leading-none tracking-[-5%] lg:px-[14px] lg:py-1.5 lg:text-[20px] lg:leading-[20px]",
											isActive
