...
export const CyberGlitchIcon = forwardRef<SVGSVGElement, CyberGlitchIconProps>(
	({ paths, className }, ref) => (
		<svg
			viewBox="0 0 14 14"
			className={className}
...
export const IconDiscord = forwardRef<SVGSVGElement, SvgIconProps>(
	(props, ref) => (
		<CyberGlitchIcon
			ref={ref}
			{...props}
...
// 2. Blog
export const IconBlog = forwardRef<SVGSVGElement, SvgIconProps>(
	(props, ref) => (
		<CyberGlitchIcon
			ref={ref}
			{...props}
...
// 3. Docs
export const IconDocs = forwardRef<SVGSVGElement, SvgIconProps>(
	(props, ref) => (
		<CyberGlitchIcon
			ref={ref}
			{...props}
...
// 4. Pricing
export const IconPricing = forwardRef<SVGSVGElement, SvgIconProps>(
	(props, ref) => (
		<CyberGlitchIcon
			ref={ref}
			{...props}
...
export const IconDashboard = forwardRef<SVGSVGElement, SvgIconProps>(
	({ className }, ref) => (
		<svg
			ref={ref}
			width="14"
