...
type ButtonIconProps = IconProps & { disabled?: boolean };
type MotionIconProps = { isOpen: boolean; className?: string };
type ProblemBgProps = ComponentPropsWithoutRef<"div">;
type GlitchIconProps = IconProps & { paths: string[] };

export const CyberGlitchIcon = forwardRef(function CyberGlitchIcon(
	{ paths, className }: GlitchIconProps,
...
export const IconCTAStart = ({ className }: IconProps) => (
	<svg
		width="24"
		height="24"
		viewBox="0 0 24 24"
...
export const IconCTADocs = ({ className }: IconProps) => (
	<svg
		width="24"
		height="24"
		viewBox="0 0 24 24"
...
export const IconDiscord = forwardRef(function IconDiscord(
	props: IconProps,
	ref: ForwardedRef<SVGSVGElement>,
) {
	return (
...
// 2. Blog
export const IconBlog = forwardRef(function IconBlog(
	props: IconProps,
	ref: ForwardedRef<SVGSVGElement>,
) {
	return (
...
// 3. Docs
export const IconDocs = forwardRef(function IconDocs(
	props: IconProps,
	ref: ForwardedRef<SVGSVGElement>,
) {
	return (
...
// 4. Pricing
export const IconPricing = forwardRef(function IconPricing(
	props: IconProps,
	ref: ForwardedRef<SVGSVGElement>,
) {
	return (
...
export const IconDashboard = forwardRef(function IconDashboard(
	{ className }: IconProps,
	ref: ForwardedRef<SVGSVGElement>,
) {
	return (
...
export const IconWebhooks = (props: IconProps) => (
	<svg
		width="24"
		height="24"
		viewBox="0 0 24 24"
...
export const IconTeam = forwardRef(function IconTeam(
	props: IconProps,
	ref: ForwardedRef<SVGSVGElement>,
) {
	return (
...
export const IconTopUp = (props: IconProps) => (
	<svg
		width="24"
		height="24"
		viewBox="0 0 24 24"
...
export const IconPlans = (props: IconProps) => (
	<svg
		width="24"
		height="24"
		viewBox="0 0 24 24"
...
export const IconVersioning = (props: IconProps) => (
	<svg
		width="24"
		height="24"
		viewBox="0 0 24 24"
...
export const IconReact = (props: IconProps) => (
	<svg
		width="24"
		height="24"
		viewBox="0 0 24 24"
...
export const IconReferral = (props: IconProps) => (
	<svg
		width="24"
		height="24"
		viewBox="0 0 24 24"
...
export const IconArrowLeft = ({
	...
	<svg
		...
		aria-hidden="true"
		focusable="false"
		className={cn(disabled ? "opacity-20" : "opacity-100", className)}
		{...props}
	>
		<g>
			<path
...
export const IconQuotes = ({ className, ...props }: IconProps) => (
	<svg
		width="27"
		height="24"
		viewBox="0 0 27 24"
...
export const IconTick = ({ className, ...props }: IconProps) => (
	<svg
		width="16"
		height="16"
		viewBox="0 0 16 16"
...
export const IconArrowRightSmall = ({ className }: { className?: string }) => (
	<motion.svg
		width="18"
		height="18"
		viewBox="0 0 18 18"
...
export const AnimatedPlusMinus = ({ isOpen, className }: MotionIconProps) => {
...
export const IconMinus = ({ className, ...props }: IconProps) => (
	<svg
		width="16"
		height="16"
		viewBox="0 0 16 16"
...
export const PixelatedPattern = ({ className, ...props }: ImageProps) => (
	<img
...
export const PRELOADER_LOGO_VIEWBOX = { width: 160, height: 236 } as const;

export const PreloaderLogo = ({ className, ...props }: IconProps) => (
	<svg
		width="160"
		height="236"
		viewBox="0 0 160 236"
...
export const ProblemBgSvg = (props: ProblemBgProps) => (
	<div
