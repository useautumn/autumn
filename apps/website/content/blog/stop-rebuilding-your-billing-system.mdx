---
title: "Stop rebuilding your billing system"
description: "How to architect a flexible billing system that handles pricing changes well"
date: "2026-06-16"
author: "John, Autumn Co-Founder"
slug: "stop-rebuilding-your-billing-system"
image: "/images/blog/billing-relational-postgres-plans.png"
heroComponent: "PostgresTablesHero"
---

One of the hardest parts of pricing is changing it. When you built your system, you hadn't planned for a version change each month, you simply wanted to ship fast. So every time your growth team comes to you with an idea for pricing, you flinch because it's not a quick fix — it's a month of rework.

We've been through this ourselves at Autumn — trying to build a system to generalize pricing changes and make them a one-day job. We've learnt a lot in doing so, and wanted to share some thoughts on how you can architect a flexible billing system that handles changes well.
...
This is definitely quick to ship, but let's now try to make a pricing change. Imagine we'd like to update the `pro` plan to cost $40 and grant 400 credits each month — <Toggle change="version">Version Pro</Toggle> to update the config. On the customer side, we'd add another column for the version of the plan the customer is on. 
...
![Configuration applied at global, plan, and customer levels](/images/blog/billing-hierarchical-config-levels.png)
