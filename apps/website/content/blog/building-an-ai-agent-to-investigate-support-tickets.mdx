...
With our logs structure in place, investigations became much more definable too. It's simply a process of identifying the type of investigation based on the incoming ticket, then iterating over queries until you have the right set of logs to make an assumption on what happened.

As such, passing this information to an agent wasn't too difficult. All we did was:
...
<Expand title="/entitlement-investigation">
