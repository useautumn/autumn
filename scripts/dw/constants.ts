...
// create/delete. dw worktree branches use `dw-wt-<N>-<hash>`; Capy VM
// branches use `capy-<bindingId>` (scripts/capy/provision.ts). Anything else is
// rejected to avoid clobbering production / staff branches.
export const BRANCH_NAME_RE =
	/^(?:dw-wt-\d+-[a-f0-9]+|capy-(?:[a-f0-9]+|[0-9a-hjkmnp-tv-z]{26}))$/;
