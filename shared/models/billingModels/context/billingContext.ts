...
export interface BillingContext {
	...
	actionSource?: string;
	/** The customer product this invoice settles. Stamped onto Stripe invoice
	 * metadata so paying it resolves back to that one row. */
	settledCustomerProductId?: string;
