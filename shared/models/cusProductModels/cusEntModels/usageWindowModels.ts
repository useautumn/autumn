 ...
 * deduction script. Built each deduction from the `usage_limits` billing
 * control plus the current window bounds (NOT stored). Carries the resolved
 * `limit` and the `key`/window so Lua can find-or-create the matching counter.
 */
