...
export const AttachDiscountFieldsSchema = z.object({
...
export const hasDiscountReference = (data: {
	reward_id?: string;
	promotion_code?: string;
}) => Boolean(data.reward_id || data.promotion_code);

export const AttachDiscountSchema = AttachDiscountFieldsSchema.refine(
