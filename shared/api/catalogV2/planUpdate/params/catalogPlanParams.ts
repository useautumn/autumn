...
import { PlanBillingControlsPatchParamsSchema } from "../../../billingControls/planBillingControls.js";
...
export const UpdateCatalogPlanParamsSchema = z
	.object({
		// ── Core ──────────────────────────────────────────────────────────────
		...
		billing_controls: PlanBillingControlsPatchParamsSchema.optional().meta({
