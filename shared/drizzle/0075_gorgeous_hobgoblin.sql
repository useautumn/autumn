...
CREATE INDEX CONCURRENTLY "idx_organizations_pending_claim_expiry" ON "organizations" USING btree ("claim_expires_at") WHERE "organizations"."claim_state" = 'pending';--> statement-breakpoint
