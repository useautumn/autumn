CREATE TABLE "chat_approval_writes" (
	...
	CONSTRAINT "chat_approval_writes_approval_position_key" UNIQUE("approval_id","position")
);
...
ALTER TABLE "chat_approval_writes" ADD CONSTRAINT "chat_approval_writes_approval_id_fkey" FOREIGN KEY ("approval_id") REFERENCES "public"."chat_approvals"("id") ON DELETE cascade ON UPDATE no action;