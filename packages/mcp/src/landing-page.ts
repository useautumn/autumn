...
export function landingPageHTML(origin: string): string {
  ...
  const mcpConfig = {
    ...
    "env": {
      ...
      "X_API_VERSION": "YOUR_VALUE_HERE",
      "FAIL_OPEN": "YOUR_VALUE_HERE",
    },
  };
  const codexConfig = `[mcp_servers.AutumnMcp]
url = "${o}/sse"
http_headers = { "secret-key" = "YOUR_SECRET_KEY", "x-api-version" = "YOUR_X_API_VERSION", "fail-open" = "YOUR_FAIL_OPEN" }`;
...
<head>
    ...
    <title>@autumn/mcp MCP</title>
    <meta name="description" content="Install @autumn/mcp MCP server.">
    <meta property="og:type" content="website">
    <meta property="og:title" content="@autumn/mcp - MCP Server">
    <meta property="og:description" content="Install @autumn/mcp MCP server.">
    <meta property="twitter:card" content="summary">
    <meta property="twitter:title" content="@autumn/mcp - MCP Server">
    <meta property="twitter:description" content="Install @autumn/mcp MCP server.">
      ...
      <div class="content-container">
          ...
          <div class="header container">
            <div class="mcp-meta">
              ...
              <div class="header-content">
                <div class="mcp-name">@autumn/mcp</div>
            ...
            <div class="header-actions">
              ...
              <div class="popover">
                ...
                <div class="popover-menu hidden" id="popover-menu">
                  <a class="popover-button install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=AutumnMcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAYXV0dW1uL21jcCIsInN0YXJ0IiwiLS1zZWNyZXQta2V5IiwiIiwiLS14LWFwaS12ZXJzaW9uIiwiMi4zLjAiLCItLWZhaWwtb3BlbiIsdHJ1ZV19">
                    Cursor
                  </a>
                  ...
                  <a class="popover-button install-link" href="vscode://ms-vscode.vscode-mcp/install?name=AutumnMcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAYXV0dW1uL21jcCIsInN0YXJ0IiwiLS1zZWNyZXQta2V5IiwiIiwiLS14LWFwaS12ZXJzaW9uIiwiMi4zLjAiLCItLWZhaWwtb3BlbiIsdHJ1ZV19">
                    VS Code
                  </a>
        ...
        <section class="install container">
          ...
          <div class="install-targets">
            <a tabindex="0" class="card install-target install-link" href="cursor://anysphere.cursor-deeplink/mcp/install?name=AutumnMcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAYXV0dW1uL21jcCIsInN0YXJ0IiwiLS1zZWNyZXQta2V5IiwiIiwiLS14LWFwaS12ZXJzaW9uIiwiMi4zLjAiLCItLWZhaWwtb3BlbiIsdHJ1ZV19">
              <div class="target">
            ...
            <a tabindex="0" class="card install-target install-link" href="vscode://ms-vscode.vscode-mcp/install?name=AutumnMcp&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyJAYXV0dW1uL21jcCIsInN0YXJ0IiwiLS1zZWNyZXQta2V5IiwiIiwiLS14LWFwaS12ZXJzaW9uIiwiMi4zLjAiLCItLWZhaWwtb3BlbiIsdHJ1ZV19">
              <div class="target">
    ...
    <div class="modal" id="claude-code-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="claude-cli-cmd">claude mcp add AutumnMcp -- npx -y @autumn/mcp start --secret-key  --x-api-version 2.3.0 --fail-open true</code>
        </div>
      </div>
    </div>
    ...
    <div class="modal" id="gemini-modal">
      ...
      <div class="content-slot">
        ...
        <div class="code-container card">
          ...
          <code class="code-snippet language-json" id="gemini-config">gemini mcp add AutumnMcp -- npx -y @autumn/mcp start --secret-key  --x-api-version 2.3.0 --fail-open true</code>
        </div>
      </div>
    </div>
