...
const attachDimensionsToUpsertLicenseEnum2Schema = z.any();

const attachDimensionsUpsertLicenseMatch3Schema = z.any();

const attachDimensionsUpsertLicense4Schema = z.any();
...
const attachDimensionsUpsertLicenseMatch3OutboundSchema = z.any();

const attachDimensionsUpsertLicense4OutboundSchema = z.any();
...
export const attachDimensionsUpsertLicense3Schema = z.object({
	match: z.record(z.string(), attachDimensionsUpsertLicenseMatch3Schema),
	priority: z.union([z.number(), z.undefined()]).optional(),
...
export const attachDimensionsUpsertLicense3OutboundSchema = z.object({
	match: z.record(
		z.string(),
		attachDimensionsUpsertLicenseMatch3OutboundSchema,
	),
	priority: z.union([z.number(), z.undefined()]).optional(),
	tier_behavior: z.literal("graduated"),
