...
const billingUpdateDimensionsUpsertLicenseMatch3Schema = z.any();

const billingUpdateDimensionsUpsertLicense4Schema = z.any();
...
const billingUpdateDimensionsUpsertLicenseMatch3OutboundSchema = z.any();

const billingUpdateDimensionsUpsertLicense4OutboundSchema = z.any();
...
export const billingUpdateDimensionsUpsertLicense3Schema = z.object({
	match: z.record(z.string(), billingUpdateDimensionsUpsertLicenseMatch3Schema),
	priority: z.union([z.number(), z.undefined()]).optional(),
...
export const billingUpdateDimensionsUpsertLicense3OutboundSchema = z.object({
	match: z.record(
		z.string(),
		billingUpdateDimensionsUpsertLicenseMatch3OutboundSchema,
	),
	priority: z.union([z.number(), z.undefined()]).optional(),
	tier_behavior: z.literal("graduated"),
