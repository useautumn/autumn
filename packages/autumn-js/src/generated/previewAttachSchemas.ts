...
export const previewAttachDimensionsUpsertLicenseMatch4Schema = z.union([
	z.string(),
	z.number(),
	z.boolean(),
]);

export const previewAttachDimensionsUpsertLicense4Schema = z.object({
	match: z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])),
	priority: z.union([z.number(), z.undefined()]).optional(),
	creditCost: z.number(),
});

export const previewAttachDimensionsUpsertLicenseMatch3Schema = z.union([
	z.string(),
	z.number(),
	z.boolean(),
]);
...
export const previewAttachUpsertLicenseExpiryOutboundSchema = z.object({
	duration: z.string(),
	length: z.number(),
});

export const previewAttachDimensionsUpsertLicenseMatch4OutboundSchema = z.union(
	[z.string(), z.number(), z.boolean()],
);

export const previewAttachDimensionsUpsertLicense4OutboundSchema = z.object({
	match: z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])),
	priority: z.union([z.number(), z.undefined()]).optional(),
	credit_cost: z.number(),
});

export const previewAttachDimensionsUpsertLicenseMatch3OutboundSchema = z.union(
	[z.string(), z.number(), z.boolean()],
);

export const previewAttachDimensionsUpsertLicenseToUnion2OutboundSchema =
	z.union([z.number(), z.string()]);

export const previewAttachDimensionsUpsertLicenseTier2OutboundSchema = z.object(
	{
...
export const previewAttachDimensionsUpsertLicense3OutboundSchema = z.object({
	match: z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])),
	priority: z.union([z.number(), z.undefined()]).optional(),
	tier_behavior: z.literal("graduated"),
	tiers: z.array(previewAttachDimensionsUpsertLicenseTier2OutboundSchema),
});
...
const previewAttachUpsertLicenseThresholdBillingSchema = z.any();
...
const previewAttachUpsertLicenseThresholdBillingOutboundSchema = z.any();
...
export const previewAttachUpsertLicenseDurationSchema = closedEnumSchema;

export const previewAttachUpsertLicenseExpirySchema = z.object({
	duration: previewAttachUpsertLicenseDurationSchema,
	length: z.number(),
});

export const previewAttachDimensionsToUpsertLicenseEnum2Schema =
	closedEnumSchema;

export const previewAttachDimensionsUpsertLicenseToUnion2Schema = z.union([
	z.number(),
	previewAttachDimensionsToUpsertLicenseEnum2Schema,
]);

export const previewAttachDimensionsUpsertLicenseTier2Schema = z.object({
	to: z.union([z.number(), previewAttachDimensionsToUpsertLicenseEnum2Schema]),
	creditCost: z.number(),
});

export const previewAttachDimensionsUpsertLicense3Schema = z.object({
	match: z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])),
	priority: z.union([z.number(), z.undefined()]).optional(),
	tierBehavior: z.literal("graduated"),
	tiers: z.array(previewAttachDimensionsUpsertLicenseTier2Schema),
});
...
export const previewAttachUpsertLicensePlanItemSchema = z.object({
	thresholdBilling: z
		.union([previewAttachUpsertLicenseThresholdBillingSchema, z.undefined()])
		.optional()
		.nullable(),
	featureId: z.string(),
	included: z.union([z.number(), z.undefined()]).optional(),
	...
	rollover: z
		...
		.optional(),
	expiry: z
		.union([previewAttachUpsertLicenseExpirySchema, z.undefined()])
		.optional(),
	featureOverride: z
...
export const previewAttachUpsertLicensePlanItemOutboundSchema = z.object({
	threshold_billing: z
		.union([
			previewAttachUpsertLicenseThresholdBillingOutboundSchema,
			z.undefined(),
		])
		.optional()
		.nullable(),
	...
	rollover: z
		...
		.optional(),
	expiry: z
		.union([previewAttachUpsertLicenseExpiryOutboundSchema, z.undefined()])
		.optional(),
	feature_override: z
		.union([
