...
export const previewUpdateDimensionsUpsertLicenseMatch4Schema = z.union([
	z.string(),
	z.number(),
	z.boolean(),
]);

export const previewUpdateDimensionsUpsertLicense4Schema = z.object({
	match: z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])),
	priority: z.union([z.number(), z.undefined()]).optional(),
	creditCost: z.number(),
});

export const previewUpdateDimensionsUpsertLicenseMatch3Schema = z.union([
	z.string(),
	z.number(),
	z.boolean(),
]);
...
export const previewUpdateRemoveDiscountSchema = z.object({
	rewardId: z.string(),
});
...
export const previewUpdateUpsertLicenseExpiryOutboundSchema = z.object({
	duration: z.string(),
	length: z.number(),
});

export const previewUpdateDimensionsUpsertLicenseMatch4OutboundSchema = z.union(
	[z.string(), z.number(), z.boolean()],
);

export const previewUpdateDimensionsUpsertLicense4OutboundSchema = z.object({
	match: z.record(z.string(), z.union([z.string(), z.number(), z.boolean()])),
	priority: z.union([z.number(), z.undefined()]).optional(),
	credit_cost: z.number(),
});

export const previewUpdateDimensionsUpsertLicenseMatch3OutboundSchema = z.union(
	[z.string(), z.number(), z.boolean()],
);
...
export const previewUpdateRemoveDiscountOutboundSchema = z.object({
	reward_id: z.string(),
});
...
export const previewUpdateUpsertLicenseDurationSchema = closedEnumSchema;

export const previewUpdateUpsertLicenseExpirySchema = z.object({
	duration: previewUpdateUpsertLicenseDurationSchema,
	length: z.number(),
});

export const previewUpdateDimensionsToUpsertLicenseEnum2Schema =
	closedEnumSchema;
...
export const previewUpdateUpsertLicensePlanItemSchema = z.object({
	...
	rollover: z
		...
		.optional(),
	expiry: z
		.union([previewUpdateUpsertLicenseExpirySchema, z.undefined()])
		.optional(),
	featureOverride: z
...
export const previewUpdateParamsSchema = z.object({
	...
	discounts: z
		...
		.optional(),
	removeDiscounts: z
		.union([z.array(previewUpdateRemoveDiscountSchema), z.undefined()])
		.optional(),
	customLineItems: z
...
export const previewUpdateUpsertLicensePlanItemOutboundSchema = z.object({
	...
	rollover: z
		...
		.optional(),
	expiry: z
		.union([previewUpdateUpsertLicenseExpiryOutboundSchema, z.undefined()])
		.optional(),
	feature_override: z
		.union([
...
export const previewUpdateParamsOutboundSchema = z.object({
	...
	discounts: z
		...
		.optional(),
	remove_discounts: z
		.union([z.array(previewUpdateRemoveDiscountOutboundSchema), z.undefined()])
		.optional(),
	custom_line_items: z
