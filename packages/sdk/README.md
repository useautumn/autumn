...
const response = await client.billing.createSchedule({ customerId: "cus_123", phases: [{"startsAt":1778175898064,"plans":[{"planId":"trial_plan"}]},{"startsAt":1779385498064,"plans":[{"planId":"pro_plan"}]}] });
```
