...
const response = await client.billing.createSchedule({ customerId: "cus_123", phases: [{"startsAt":1785776972374,"plans":[{"planId":"trial_plan"}]},{"startsAt":1786986572374,"plans":[{"planId":"pro_plan"}]}] });
```
