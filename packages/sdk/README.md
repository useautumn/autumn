...
const response = await client.billing.createSchedule({ customerId: "cus_123", phases: [{"startsAt":1783604863288,"plans":[{"planId":"trial_plan"}]},{"startsAt":1784814463288,"plans":[{"planId":"pro_plan"}]}] });
```
