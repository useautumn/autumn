...
const response = await client.billing.createSchedule({ customerId: "cus_123", phases: [{"startsAt":1782831818488,"plans":[{"planId":"trial_plan"}]},{"startsAt":1784041418488,"plans":[{"planId":"pro_plan"}]}] });
```
