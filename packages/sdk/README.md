...
const response = await client.billing.createSchedule({ customerId: "cus_123", phases: [{"startsAt":1785777177984,"plans":[{"planId":"trial_plan"}]},{"startsAt":1786986777984,"plans":[{"planId":"pro_plan"}]}] });
```
