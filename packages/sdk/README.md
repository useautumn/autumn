...
const response = await client.billing.createSchedule({ customerId: "cus_123", phases: [{"startsAt":1785775617233,"plans":[{"planId":"trial_plan"}]},{"startsAt":1786985217233,"plans":[{"planId":"pro_plan"}]}] });
```
