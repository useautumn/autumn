...
```typescript
import { TrackBalance } from "@useautumn/sdk";

let value: TrackBalance = {
  featureId: "messages",
  granted: 100,
  remaining: 72,
  usage: 28,
...
| `feature`                                                                     | [models.TrackBalanceFeature](../models/track-balance-feature.md)              | :heavy_minus_sign:                                                            | The full feature object if expanded.                                          |
...
| `breakdown`                                                                   | [models.TrackBalanceBreakdown](../models/track-balance-breakdown.md)[]        | :heavy_minus_sign:                                                            | Detailed breakdown of balance sources when stacking multiple plans or grants. |
| `rollovers`                                                                   | [models.TrackBalanceRollover](../models/track-balance-rollover.md)[]          | :heavy_minus_sign:                                                            | Rollover balances carried over from previous periods.                         |