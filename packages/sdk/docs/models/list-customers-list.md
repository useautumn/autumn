...
| `balances`                                                                                                                  | Record<string, [models.ListCustomersBalances](../models/list-customers-balances.md)>                                        | :heavy_check_mark:                                                                                                          | Feature balances keyed by feature ID, showing usage limits and remaining amounts.                                           |