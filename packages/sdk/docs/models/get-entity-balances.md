...
```typescript
import { GetEntityBalances } from "@useautumn/sdk";

let value: GetEntityBalances = {
  featureId: "messages",
  granted: 100,
  remaining: 72,
  usage: 28,
...
| `feature`                                                                     | [models.GetEntityFeature](../models/get-entity-feature.md)                    | :heavy_minus_sign:                                                            | The full feature object if expanded.                                          |
...
| `breakdown`                                                                   | [models.GetEntityBreakdown](../models/get-entity-breakdown.md)[]              | :heavy_minus_sign:                                                            | Detailed breakdown of balance sources when stacking multiple plans or grants. |
| `rollovers`                                                                   | [models.GetEntityRollover](../models/get-entity-rollover.md)[]                | :heavy_minus_sign:                                                            | Rollover balances carried over from previous periods.                         |