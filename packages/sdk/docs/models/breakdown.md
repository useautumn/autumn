...
| `reset`                                                                    | [models.BalanceReset](../models/balance-reset.md)                          | :heavy_check_mark:                                                         | Reset configuration for this balance, or null if no reset.                 |
| `price`                                                                    | [models.BalancePrice](../models/balance-price.md)                          | :heavy_check_mark:                                                         | Pricing configuration if this balance has usage-based pricing.             |
