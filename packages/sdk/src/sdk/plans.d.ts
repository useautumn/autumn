...
export declare class Plans extends ClientSDK {
     ...
     */
    create(request: models.CreatePlanParams, options?: RequestOptions): Promise<models.CreatePlanResponse>;
    /**
     * Get a plan
     *
     * @remarks
     ...
     */
    get(request: models.GetPlanParams, options?: RequestOptions): Promise<models.GetPlanResponse>;
    /**
     * List all plans
     *
     * @remarks
     ...
     */
    list(request?: models.ListPlansParams | undefined, options?: RequestOptions): Promise<models.ListPlansResponse>;
    /**
     * Update a plan
     *
     * @remarks
     ...
     */
    update(request: models.UpdatePlanParams, options?: RequestOptions): Promise<models.UpdatePlanResponse>;
    /**
     * Delete a plan
     *
     * @remarks
     ...
     */
    delete(request: models.DeletePlanParams, options?: RequestOptions): Promise<models.DeletePlanResponse>;
}
