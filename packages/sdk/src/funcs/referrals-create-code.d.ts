 ...
 */
export declare function referralsCreateCode(client: AutumnCore, request: models.CreateReferralCodeParams, options?: RequestOptions): APIPromise<Result<models.CreateReferralCodeResponse, AutumnError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
