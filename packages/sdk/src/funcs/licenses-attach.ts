 ...
 */
export function licensesAttach(
  client: AutumnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.AttachLicenseParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/licenses.attach")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AttachLicenseResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
