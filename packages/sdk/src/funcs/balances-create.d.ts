 ...
 */
export declare function balancesCreate(client: AutumnCore, request: models.CreateBalanceParams, options?: RequestOptions): APIPromise<Result<models.CreateBalanceResponse, AutumnError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
