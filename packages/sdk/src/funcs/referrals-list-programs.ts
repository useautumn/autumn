 ...
 */
export function referralsListPrograms(
  client: AutumnCore,
  _request?: models.ListReferralProgramsParams | undefined,
...
> {
  const path = pathToFunc("/v1/referral_programs.list")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListReferralProgramsResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
