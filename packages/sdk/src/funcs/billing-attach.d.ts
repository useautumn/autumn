 ...
 */
export declare function billingAttach(client: AutumnCore, request: models.AttachParams, options?: RequestOptions): APIPromise<Result<models.AttachResponse, AutumnError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
