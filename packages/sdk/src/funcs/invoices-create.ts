...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreateInvoiceParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/invoices.create")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateInvoiceResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
