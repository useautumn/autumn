...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.UpdateRewardParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/rewards.update")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UpdateRewardResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
