...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.GetRewardParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/rewards.get")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetRewardResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
