...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.ListLicensesParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/licenses.list")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListLicensesResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
