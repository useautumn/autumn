 ...
 */
export declare function referralsRedeemCode(client: AutumnCore, request: models.RedeemReferralCodeParams, options?: RequestOptions): APIPromise<Result<models.RedeemReferralCodeResponse, AutumnError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
