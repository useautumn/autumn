 ...
 */
export function licensesRelease(
  client: AutumnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.ReleaseLicenseParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/licenses.release")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ReleaseLicenseResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
