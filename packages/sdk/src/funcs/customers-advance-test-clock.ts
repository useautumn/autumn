 ...
 */
export function customersAdvanceTestClock(
  client: AutumnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.AdvanceTestClockParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/customers.advance_test_clock")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AdvanceTestClockResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
