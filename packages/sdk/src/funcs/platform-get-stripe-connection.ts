 ...
 */
export function platformGetStripeConnection(
  client: AutumnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.GetStripeConnectionParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/platform.get_stripe_connection")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.GetStripeConnectionResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
