 ...
 */
export function sandboxesDelete(
  client: AutumnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.DeleteSandboxParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/sandboxes.delete")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteSandboxResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
