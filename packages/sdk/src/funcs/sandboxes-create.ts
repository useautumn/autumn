 ...
 */
export function sandboxesCreate(
  client: AutumnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CreateSandboxParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/sandboxes.create")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateSandboxResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
