...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.DeleteRewardParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/rewards.delete")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DeleteRewardResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
