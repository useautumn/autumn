 ...
 */
export function platformDisconnectStripe(
  client: AutumnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.DisconnectStripeParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/platform.disconnect_stripe")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.DisconnectStripeResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
