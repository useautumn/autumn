 ...
 */
export function licensesListAssignments(
  client: AutumnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.ListLicenseAssignmentsParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/licenses.list_assignments")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListLicenseAssignmentsResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
