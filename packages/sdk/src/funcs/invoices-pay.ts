...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.PayInvoiceParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/invoices.pay")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.PayInvoiceResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
