...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.SearchRequestLogsParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/logs.search")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SearchRequestLogsResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
