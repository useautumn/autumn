...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.ListInvoicesParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/invoices.list")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListInvoicesResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
