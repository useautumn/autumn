 ...
 */
export function invoicesListTemplates(
  client: AutumnCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.ListInvoiceTemplatesParams$outboundSchema, value),
  ...
  const path = pathToFunc("/v1/invoices.listTemplates")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ListInvoiceTemplatesResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
