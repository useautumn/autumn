 ...
 */
export function sandboxesReset(
  client: AutumnCore,
  _request: models.ResetSandboxParams,
...
> {
  const path = pathToFunc("/v1/sandboxes.reset")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ResetSandboxResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
