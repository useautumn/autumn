import { AutumnDefaultError } from "../models/autumn-default-error.js";
...
export declare function match<T, E>(...matchers: Array<Matcher<T, E>>): MatchFunc<T, E | AutumnDefaultError | ResponseValidationError>;
/**
