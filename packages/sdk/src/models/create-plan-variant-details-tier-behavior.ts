...
export const CreatePlanToRequestBodyEnum = {
  Inf: "inf",
} as const;
export type CreatePlanToRequestBodyEnum = ClosedEnum<
  typeof CreatePlanToRequestBodyEnum
>;

/**
 * Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'.
 */
export type CreatePlanFeatureOverrideToRequestBodyUnion =
  | number
  | CreatePlanToRequestBodyEnum;

export type CreatePlanFeatureOverrideTierRequestBody = {
  /**
   * Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'.
   */
  to: number | CreatePlanToRequestBodyEnum;
  /**
...
export type CreatePlanCreditSchemaItemRequestBody1 = {
  ...
  tiers: Array<CreatePlanFeatureOverrideTierRequestBody>;
};
...
export const CreatePlanToResponseEnum = {
  Inf: "inf",
} as const;
export type CreatePlanToResponseEnum = ClosedEnum<
  typeof CreatePlanToResponseEnum
>;

/**
 * Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'.
 */
export type CreatePlanFeatureOverrideToResponseUnion =
  | number
...
export type CreatePlanItemFeatureOverrideTierResponse = {
   ...
   * Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'.
   */
  to: number | CreatePlanToResponseEnum;
  /**
   * Credits consumed per billing-unit group within this tier.
   */
  creditCost: number;
...
/** @internal */
export const CreatePlanToRequestBodyEnum$outboundSchema: z.ZodMiniEnum<
  typeof CreatePlanToRequestBodyEnum
> = z.enum(CreatePlanToRequestBodyEnum);

/** @internal */
export type CreatePlanFeatureOverrideToRequestBodyUnion$Outbound =
  | number
  | string;

/** @internal */
export const CreatePlanFeatureOverrideToRequestBodyUnion$outboundSchema:
  z.ZodMiniType<
    CreatePlanFeatureOverrideToRequestBodyUnion$Outbound,
    CreatePlanFeatureOverrideToRequestBodyUnion
  > = smartUnion([z.number(), CreatePlanToRequestBodyEnum$outboundSchema]);

export function createPlanFeatureOverrideToRequestBodyUnionToJSON(
  createPlanFeatureOverrideToRequestBodyUnion:
    CreatePlanFeatureOverrideToRequestBodyUnion,
): string {
  return JSON.stringify(
    CreatePlanFeatureOverrideToRequestBodyUnion$outboundSchema.parse(
      createPlanFeatureOverrideToRequestBodyUnion,
    ),
  );
}
...
/** @internal */
export type CreatePlanFeatureOverrideTierRequestBody$Outbound = {
  to: number | string;
  credit_cost: number;
};

/** @internal */
export const CreatePlanFeatureOverrideTierRequestBody$outboundSchema:
  z.ZodMiniType<
    CreatePlanFeatureOverrideTierRequestBody$Outbound,
    CreatePlanFeatureOverrideTierRequestBody
  > = z.pipe(
    z.object({
      to: smartUnion([z.number(), CreatePlanToRequestBodyEnum$outboundSchema]),
      creditCost: z.number(),
    }),
    z.transform((v) => {
      return remap$(v, {
...
export function createPlanFeatureOverrideTierRequestBodyToJSON(
  createPlanFeatureOverrideTierRequestBody:
    CreatePlanFeatureOverrideTierRequestBody,
): string {
  return JSON.stringify(
    CreatePlanFeatureOverrideTierRequestBody$outboundSchema.parse(
      createPlanFeatureOverrideTierRequestBody,
    ),
  );
}
...
export type CreatePlanCreditSchemaItemRequestBody1$Outbound = {
  ...
  tiers: Array<CreatePlanFeatureOverrideTierRequestBody$Outbound>;
};
...
export const CreatePlanCreditSchemaItemRequestBody1$outboundSchema:
  ...
  > = z.pipe(
    z.object({
      ...
      tiers: z.array(
        z.lazy(() => CreatePlanFeatureOverrideTierRequestBody$outboundSchema),
      ),
    }),
    z.transform((v) => {
      return remap$(v, {
...
/** @internal */
export const CreatePlanToResponseEnum$inboundSchema: z.ZodMiniEnum<
  typeof CreatePlanToResponseEnum
> = z.enum(CreatePlanToResponseEnum);

/** @internal */
export const CreatePlanFeatureOverrideToResponseUnion$inboundSchema:
  z.ZodMiniType<CreatePlanFeatureOverrideToResponseUnion, unknown> = smartUnion(
    [types.number(), CreatePlanToResponseEnum$inboundSchema],
  );

export function createPlanFeatureOverrideToResponseUnionFromJSON(
  jsonString: string,
): SafeParseResult<
...
> {
  return safeParse(
    jsonString,
    (x) =>
      CreatePlanFeatureOverrideToResponseUnion$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CreatePlanFeatureOverrideToResponseUnion' from JSON`,
  );
}
...
export const CreatePlanItemFeatureOverrideTierResponse$inboundSchema:
  z.ZodMiniType<CreatePlanItemFeatureOverrideTierResponse, unknown> = z.pipe(
    z.object({
      to: smartUnion([types.number(), CreatePlanToResponseEnum$inboundSchema]),
      credit_cost: types.number(),
    }),
    z.transform((v) => {
      return remap$(v, {
  ...
  z.ZodMiniType<CreatePlanCreditSchemaItemFeatureOverrideResponse1, unknown> = z
    .pipe(
      z.object({
        ...
        tiers: z.array(
          z.lazy(() => CreatePlanItemFeatureOverrideTierResponse$inboundSchema),
        ),
      }),
      z.transform((v) => {
        return remap$(v, {
