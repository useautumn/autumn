...
export const SetupPaymentItemDuration = {
  Day: "day",
  Week: "week",
  Month: "month",
  Year: "year",
} as const;
export type SetupPaymentItemDuration = ClosedEnum<
  typeof SetupPaymentItemDuration
>;

/**
 * Purchased units expire this long after each purchase. One-off prepaid consumable items only.
 */
export type SetupPaymentItemExpiry = {
...
export type SetupPaymentItemPlanItem = {
   ...
   * Purchased units expire this long after each purchase. One-off prepaid consumable items only.
   */
  expiry?: SetupPaymentItemExpiry | undefined;
  /**
   * Overrides fields of this item's feature for customers on this plan (e.g. a credit system's credit_schema).
   */
...
export const SetupPaymentAddItemDuration = {
  Day: "day",
  Week: "week",
  Month: "month",
  Year: "year",
} as const;
export type SetupPaymentAddItemDuration = ClosedEnum<
  typeof SetupPaymentAddItemDuration
>;

/**
 * Purchased units expire this long after each purchase. One-off prepaid consumable items only.
 */
export type SetupPaymentAddItemExpiry = {
...
export type SetupPaymentAddItemPlanItem = {
   ...
   * Purchased units expire this long after each purchase. One-off prepaid consumable items only.
   */
  expiry?: SetupPaymentAddItemExpiry | undefined;
  /**
   * Overrides fields of this item's feature for customers on this plan (e.g. a credit system's credit_schema).
   */
...
/** @internal */
export const SetupPaymentItemDuration$outboundSchema: z.ZodMiniEnum<
  typeof SetupPaymentItemDuration
> = z.enum(SetupPaymentItemDuration);

/** @internal */
export type SetupPaymentItemExpiry$Outbound = {
  duration: string;
  length: number;
};

/** @internal */
export const SetupPaymentItemExpiry$outboundSchema: z.ZodMiniType<
  SetupPaymentItemExpiry$Outbound,
  SetupPaymentItemExpiry
> = z.object({
  duration: SetupPaymentItemDuration$outboundSchema,
  length: z.number(),
});

export function setupPaymentItemExpiryToJSON(
  setupPaymentItemExpiry: SetupPaymentItemExpiry,
): string {
  return JSON.stringify(
    SetupPaymentItemExpiry$outboundSchema.parse(setupPaymentItemExpiry),
  );
}
...
export type SetupPaymentItemPlanItem$Outbound = {
  ...
  expiry?: SetupPaymentItemExpiry$Outbound | undefined;
...
> = z.pipe(
  z.object({
    ...
    expiry: z.optional(z.lazy(() => SetupPaymentItemExpiry$outboundSchema)),
...
/** @internal */
export const SetupPaymentAddItemDuration$outboundSchema: z.ZodMiniEnum<
  typeof SetupPaymentAddItemDuration
> = z.enum(SetupPaymentAddItemDuration);

/** @internal */
export type SetupPaymentAddItemExpiry$Outbound = {
  duration: string;
  length: number;
};

/** @internal */
export const SetupPaymentAddItemExpiry$outboundSchema: z.ZodMiniType<
  SetupPaymentAddItemExpiry$Outbound,
  SetupPaymentAddItemExpiry
> = z.object({
  duration: SetupPaymentAddItemDuration$outboundSchema,
  length: z.number(),
});

export function setupPaymentAddItemExpiryToJSON(
  setupPaymentAddItemExpiry: SetupPaymentAddItemExpiry,
): string {
  return JSON.stringify(
    SetupPaymentAddItemExpiry$outboundSchema.parse(setupPaymentAddItemExpiry),
  );
}
...
export type SetupPaymentAddItemPlanItem$Outbound = {
  ...
  expiry?: SetupPaymentAddItemExpiry$Outbound | undefined;
...
> = z.pipe(
  z.object({
    ...
    expiry: z.optional(z.lazy(() => SetupPaymentAddItemExpiry$outboundSchema)),
    featureOverride: z.optional(
