...
export type AttachItemThresholdBilling = {
  threshold: number;
};
...
export const AttachItemDuration = {
  Day: "day",
  Week: "week",
  Month: "month",
  Year: "year",
} as const;
export type AttachItemDuration = ClosedEnum<typeof AttachItemDuration>;

/**
 * Purchased units expire this long after each purchase. One-off prepaid consumable items only.
 */
export type AttachItemExpiry = {
...
export type AttachItemPlanItem = {
   ...
   */
  thresholdBilling?: AttachItemThresholdBilling | null | undefined;
  /**
   ...
   * Purchased units expire this long after each purchase. One-off prepaid consumable items only.
   */
  expiry?: AttachItemExpiry | undefined;
  /**
   * Overrides fields of this item's feature for customers on this plan (e.g. a credit system's credit_schema).
   */
...
export type AttachAddItemThresholdBilling = {
  threshold: number;
};
...
export const AttachAddItemDuration = {
  Day: "day",
  Week: "week",
  Month: "month",
  Year: "year",
} as const;
export type AttachAddItemDuration = ClosedEnum<typeof AttachAddItemDuration>;

/**
 * Purchased units expire this long after each purchase. One-off prepaid consumable items only.
 */
export type AttachAddItemExpiry = {
...
export type AttachAddItemPlanItem = {
   ...
   * Bills this many feature units when outstanding overage reaches it.
   */
  thresholdBilling?: AttachAddItemThresholdBilling | null | undefined;
  /**
   * The ID of the feature to configure.
   */
  featureId: string;
   ...
   * Purchased units expire this long after each purchase. One-off prepaid consumable items only.
   */
  expiry?: AttachAddItemExpiry | undefined;
  /**
   * Overrides fields of this item's feature for customers on this plan (e.g. a credit system's credit_schema).
   */
...
export type AttachUpsertLicenseThresholdBilling = {
  threshold: number;
};
...
> = z.pipe(
  z.object({
    ...
    onEnd: z._default(AttachOnEnd$outboundSchema, "bill"),
  }),
  z.transform((v) => {
    return remap$(v, {
...
/** @internal */
export type AttachItemThresholdBilling$Outbound = {
  threshold: number;
};

/** @internal */
export const AttachItemThresholdBilling$outboundSchema: z.ZodMiniType<
  AttachItemThresholdBilling$Outbound,
  AttachItemThresholdBilling
> = z.object({
  threshold: z.number(),
});

export function attachItemThresholdBillingToJSON(
  attachItemThresholdBilling: AttachItemThresholdBilling,
): string {
  return JSON.stringify(
    AttachItemThresholdBilling$outboundSchema.parse(attachItemThresholdBilling),
  );
}
...
/** @internal */
export const AttachItemDuration$outboundSchema: z.ZodMiniEnum<
  typeof AttachItemDuration
> = z.enum(AttachItemDuration);

/** @internal */
export type AttachItemExpiry$Outbound = {
  duration: string;
  length: number;
};

/** @internal */
export const AttachItemExpiry$outboundSchema: z.ZodMiniType<
  AttachItemExpiry$Outbound,
  AttachItemExpiry
> = z.object({
  duration: AttachItemDuration$outboundSchema,
  length: z.number(),
});

export function attachItemExpiryToJSON(
  attachItemExpiry: AttachItemExpiry,
): string {
  return JSON.stringify(
    AttachItemExpiry$outboundSchema.parse(attachItemExpiry),
  );
}
...
export type AttachItemPlanItem$Outbound = {
  threshold_billing?: AttachItemThresholdBilling$Outbound | null | undefined;
  feature_id: string;
  included?: number | undefined;
  unlimited?: boolean | undefined;
  pooled: boolean;
  ...
  expiry?: AttachItemExpiry$Outbound | undefined;
...
> = z.pipe(
  z.object({
    thresholdBilling: z.optional(
      z.nullable(z.lazy(() => AttachItemThresholdBilling$outboundSchema)),
    ),
    featureId: z.string(),
    ...
    expiry: z.optional(z.lazy(() => AttachItemExpiry$outboundSchema)),
...
/** @internal */
export type AttachAddItemThresholdBilling$Outbound = {
  threshold: number;
};

/** @internal */
export const AttachAddItemThresholdBilling$outboundSchema: z.ZodMiniType<
  AttachAddItemThresholdBilling$Outbound,
  AttachAddItemThresholdBilling
> = z.object({
  threshold: z.number(),
});

export function attachAddItemThresholdBillingToJSON(
  attachAddItemThresholdBilling: AttachAddItemThresholdBilling,
): string {
  return JSON.stringify(
    AttachAddItemThresholdBilling$outboundSchema.parse(
      attachAddItemThresholdBilling,
    ),
  );
}
...
/** @internal */
export const AttachAddItemDuration$outboundSchema: z.ZodMiniEnum<
  typeof AttachAddItemDuration
> = z.enum(AttachAddItemDuration);

/** @internal */
export type AttachAddItemExpiry$Outbound = {
  duration: string;
  length: number;
};

/** @internal */
export const AttachAddItemExpiry$outboundSchema: z.ZodMiniType<
  AttachAddItemExpiry$Outbound,
  AttachAddItemExpiry
> = z.object({
  duration: AttachAddItemDuration$outboundSchema,
  length: z.number(),
});

export function attachAddItemExpiryToJSON(
  attachAddItemExpiry: AttachAddItemExpiry,
): string {
  return JSON.stringify(
    AttachAddItemExpiry$outboundSchema.parse(attachAddItemExpiry),
  );
}
...
export type AttachAddItemPlanItem$Outbound = {
  threshold_billing?: AttachAddItemThresholdBilling$Outbound | null | undefined;
  feature_id: string;
  included?: number | undefined;
  unlimited?: boolean | undefined;
  pooled: boolean;
  ...
  expiry?: AttachAddItemExpiry$Outbound | undefined;
...
> = z.pipe(
  z.object({
    thresholdBilling: z.optional(
      z.nullable(z.lazy(() => AttachAddItemThresholdBilling$outboundSchema)),
    ),
    featureId: z.string(),
    included: z.optional(z.number()),
    unlimited: z.optional(z.boolean()),
    ...
    expiry: z.optional(z.lazy(() => AttachAddItemExpiry$outboundSchema)),
    featureOverride: z.optional(
...
> = z.pipe(
  z.object({
    ...
    cardRequired: z._default(z.boolean(), false),
    onEnd: z._default(AttachCustomizeOnEnd$outboundSchema, "bill"),
  }),
  z.transform((v) => {
    return remap$(v, {
      durationLength: "duration_length",
...
/** @internal */
export type AttachUpsertLicenseThresholdBilling$Outbound = {
  threshold: number;
};

/** @internal */
export const AttachUpsertLicenseThresholdBilling$outboundSchema: z.ZodMiniType<
...
export function attachUpsertLicenseThresholdBillingToJSON(
  attachUpsertLicenseThresholdBilling: AttachUpsertLicenseThresholdBilling,
): string {
  return JSON.stringify(
    AttachUpsertLicenseThresholdBilling$outboundSchema.parse(
      attachUpsertLicenseThresholdBilling,
    ),
  );
}
