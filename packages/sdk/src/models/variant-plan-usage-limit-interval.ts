...
import {
  ...
  ListPlansVariantAddItemDimensionsUnion1$inboundSchema,
  ListPlansVariantAddItemExpiry,
  ListPlansVariantAddItemExpiry$inboundSchema,
  ...
  ListPlansVariantAddItemMultipliers1$inboundSchema,
...
export type ListPlansCreditSchemaVariantAddItem1 = {
   ...
   */
  dimensions?:
    | { [k: string]: ListPlansVariantAddItemDimensionsUnion1 }
    | undefined;
  /**
...
export type ListPlansVariantPlanItem = {
   ...
   */
  expiry?: ListPlansVariantAddItemExpiry | undefined;
  /**
   * Overrides fields of this item's feature for customers on this plan (e.g. a credit system's credit_schema).
   */
...
export const ListPlansVariantUpsertLicenseDuration = {
  Day: "day",
  Week: "week",
  Month: "month",
  Year: "year",
} as const;
export type ListPlansVariantUpsertLicenseDuration = OpenEnum<
  typeof ListPlansVariantUpsertLicenseDuration
>;

/**
 * Purchased units expire this long after each purchase. One-off prepaid consumable items only.
 */
export type ListPlansVariantUpsertLicenseExpiry = {
...
> = z.pipe(
  z.object({
    ...
    multipliers: types.optional(
      z.record(z.string(), ListPlansVariantAddItemMultipliers1$inboundSchema),
    ),
    tier_behavior: types.literal("graduated"),
    tiers: z.array(ListPlansVariantAddItemFeatureOverrideTier$inboundSchema),
  }),
  z.transform((v) => {
    return remap$(v, {
...
> = z.pipe(
  z.object({
    threshold_billing: z.optional(
      z.nullable(ListPlansVariantAddItemThresholdBilling$inboundSchema),
    ),
    feature_id: types.string(),
    included: types.optional(types.number()),
    unlimited: types.optional(types.boolean()),
    pooled: z._default(types.boolean(), false),
    reset: types.optional(ListPlansVariantAddItemReset$inboundSchema),
    price: types.optional(ListPlansVariantAddItemPrice$inboundSchema),
    proration: types.optional(ListPlansVariantProration$inboundSchema),
    rollover: types.optional(ListPlansVariantAddItemRollover$inboundSchema),
    expiry: types.optional(ListPlansVariantAddItemExpiry$inboundSchema),
...
/** @internal */
export const ListPlansVariantUpsertLicenseDuration$inboundSchema: z.ZodMiniType<
  ListPlansVariantUpsertLicenseDuration,
  unknown
> = openEnums.inboundSchema(ListPlansVariantUpsertLicenseDuration);

/** @internal */
export const ListPlansVariantUpsertLicenseExpiry$inboundSchema: z.ZodMiniType<
  ListPlansVariantUpsertLicenseExpiry,
  unknown
> = z.object({
  duration: ListPlansVariantUpsertLicenseDuration$inboundSchema,
  length: types.number(),
});

export function listPlansVariantUpsertLicenseExpiryFromJSON(
  jsonString: string,
): SafeParseResult<ListPlansVariantUpsertLicenseExpiry, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      ListPlansVariantUpsertLicenseExpiry$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ListPlansVariantUpsertLicenseExpiry' from JSON`,
  );
}
