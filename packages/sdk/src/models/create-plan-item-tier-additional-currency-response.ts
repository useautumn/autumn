...
export const CreatePlanItemDurationRequestBody = {
  Day: "day",
  Week: "week",
  Month: "month",
  Year: "year",
} as const;
export type CreatePlanItemDurationRequestBody = ClosedEnum<
  typeof CreatePlanItemDurationRequestBody
>;

/**
 * Purchased units expire this long after each purchase. One-off prepaid consumable items only.
 */
export type CreatePlanItemExpiryRequestBody = {
  duration: CreatePlanItemDurationRequestBody;
  length: number;
};
...
export type CreatePlanItemPlanItem = {
   ...
   * Purchased units expire this long after each purchase. One-off prepaid consumable items only.
   */
  expiry?: CreatePlanItemExpiryRequestBody | undefined;
  /**
   * Overrides fields of this item's feature for customers on this plan (e.g. a credit system's credit_schema).
   */
...
/** @internal */
export const CreatePlanItemDurationRequestBody$outboundSchema: z.ZodMiniEnum<
  typeof CreatePlanItemDurationRequestBody
> = z.enum(CreatePlanItemDurationRequestBody);

/** @internal */
export type CreatePlanItemExpiryRequestBody$Outbound = {
  duration: string;
  length: number;
};

/** @internal */
export const CreatePlanItemExpiryRequestBody$outboundSchema: z.ZodMiniType<
  CreatePlanItemExpiryRequestBody$Outbound,
  CreatePlanItemExpiryRequestBody
> = z.object({
  duration: CreatePlanItemDurationRequestBody$outboundSchema,
  length: z.number(),
});

export function createPlanItemExpiryRequestBodyToJSON(
  createPlanItemExpiryRequestBody: CreatePlanItemExpiryRequestBody,
): string {
  return JSON.stringify(
    CreatePlanItemExpiryRequestBody$outboundSchema.parse(
      createPlanItemExpiryRequestBody,
    ),
  );
}
...
export type CreatePlanItemPlanItem$Outbound = {
  ...
  expiry?: CreatePlanItemExpiryRequestBody$Outbound | undefined;
  feature_override?:
    | CreatePlanItemFeatureOverrideRequestBody$Outbound
    | undefined;
};
...
> = z.pipe(
  z.object({
    ...
    expiry: z.optional(
      z.lazy(() => CreatePlanItemExpiryRequestBody$outboundSchema),
    ),
