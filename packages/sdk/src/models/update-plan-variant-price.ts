...
export const UpdatePlanItemDurationRequestBody = {
  Day: "day",
  Week: "week",
  Month: "month",
  Year: "year",
} as const;
export type UpdatePlanItemDurationRequestBody = ClosedEnum<
  typeof UpdatePlanItemDurationRequestBody
>;

/**
 * Purchased units expire this long after each purchase. One-off prepaid consumable items only.
 */
export type UpdatePlanItemExpiryRequestBody = {
  duration: UpdatePlanItemDurationRequestBody;
  length: number;
};
...
export type UpdatePlanItemPlanItem = {
   ...
   * Purchased units expire this long after each purchase. One-off prepaid consumable items only.
   */
  expiry?: UpdatePlanItemExpiryRequestBody | undefined;
  /**
   * Overrides fields of this item's feature for customers on this plan (e.g. a credit system's credit_schema).
   */
...
/** @internal */
export const UpdatePlanItemDurationRequestBody$outboundSchema: z.ZodMiniEnum<
  typeof UpdatePlanItemDurationRequestBody
> = z.enum(UpdatePlanItemDurationRequestBody);

/** @internal */
export type UpdatePlanItemExpiryRequestBody$Outbound = {
  duration: string;
  length: number;
};

/** @internal */
export const UpdatePlanItemExpiryRequestBody$outboundSchema: z.ZodMiniType<
  UpdatePlanItemExpiryRequestBody$Outbound,
  UpdatePlanItemExpiryRequestBody
> = z.object({
  duration: UpdatePlanItemDurationRequestBody$outboundSchema,
  length: z.number(),
});

export function updatePlanItemExpiryRequestBodyToJSON(
  updatePlanItemExpiryRequestBody: UpdatePlanItemExpiryRequestBody,
): string {
  return JSON.stringify(
    UpdatePlanItemExpiryRequestBody$outboundSchema.parse(
      updatePlanItemExpiryRequestBody,
    ),
  );
}
...
export type UpdatePlanItemPlanItem$Outbound = {
  ...
  expiry?: UpdatePlanItemExpiryRequestBody$Outbound | undefined;
  feature_override?:
    | UpdatePlanItemFeatureOverrideRequestBody$Outbound
    | undefined;
};
...
> = z.pipe(
  z.object({
    ...
    expiry: z.optional(
      z.lazy(() => UpdatePlanItemExpiryRequestBody$outboundSchema),
    ),
