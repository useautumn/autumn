...
export const UnscheduledPlanUpsertLicenseDuration = {
  Day: "day",
  Week: "week",
  Month: "month",
  Year: "year",
} as const;
export type UnscheduledPlanUpsertLicenseDuration = ClosedEnum<
  typeof UnscheduledPlanUpsertLicenseDuration
>;

/**
 * Purchased units expire this long after each purchase. One-off prepaid consumable items only.
 */
export type UnscheduledPlanUpsertLicenseExpiry = {
...
export type UnscheduledPlanUpsertLicensePlanItem = {
   ...
   * Purchased units expire this long after each purchase. One-off prepaid consumable items only.
   */
  expiry?: UnscheduledPlanUpsertLicenseExpiry | undefined;
  /**
   * Overrides fields of this item's feature for customers on this plan (e.g. a credit system's credit_schema).
   */
...
/** @internal */
export const UnscheduledPlanUpsertLicenseDuration$outboundSchema: z.ZodMiniEnum<
  typeof UnscheduledPlanUpsertLicenseDuration
> = z.enum(UnscheduledPlanUpsertLicenseDuration);

/** @internal */
export type UnscheduledPlanUpsertLicenseExpiry$Outbound = {
  duration: string;
  length: number;
};

/** @internal */
export const UnscheduledPlanUpsertLicenseExpiry$outboundSchema: z.ZodMiniType<
  UnscheduledPlanUpsertLicenseExpiry$Outbound,
  UnscheduledPlanUpsertLicenseExpiry
> = z.object({
  duration: UnscheduledPlanUpsertLicenseDuration$outboundSchema,
  length: z.number(),
});

export function unscheduledPlanUpsertLicenseExpiryToJSON(
  unscheduledPlanUpsertLicenseExpiry: UnscheduledPlanUpsertLicenseExpiry,
): string {
  return JSON.stringify(
    UnscheduledPlanUpsertLicenseExpiry$outboundSchema.parse(
      unscheduledPlanUpsertLicenseExpiry,
    ),
  );
}
...
export const UnscheduledPlanUpsertLicenseDimensionsUnion2$outboundSchema:
  ...
  > = smartUnion([
    ...
    z.lazy(() => DimensionsUnscheduledPlanUpsertLicense4$outboundSchema),
  ]);
...
export type UnscheduledPlanUpsertLicensePlanItem$Outbound = {
  ...
  expiry?: UnscheduledPlanUpsertLicenseExpiry$Outbound | undefined;
  feature_override?:
    | UnscheduledPlanUpsertLicenseFeatureOverride$Outbound
    | undefined;
};
...
> = z.pipe(
  z.object({
    thresholdBilling: z.optional(
      z.nullable(UnscheduledPlanUpsertLicenseThresholdBilling$outboundSchema),
    ),
    featureId: z.string(),
    ...
    rollover: z.optional(
      z.lazy(() => UnscheduledPlanUpsertLicenseRollover$outboundSchema),
    ),
    expiry: z.optional(
      z.lazy(() => UnscheduledPlanUpsertLicenseExpiry$outboundSchema),
    ),
