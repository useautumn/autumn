...
- [ ] 6 Done — suggested integration next, didn't start it

For item 4, `autumn-catalog` owns the conversation and its own checklist replaces this one until the config is written and approved — show its checklist, not this one, while modeling. Come back here for push and wrap-up.
