...
- If a customization is inferred, build its most literal reading — the preview is its confirmation. If the user disputes it, do not carry it into another preview unless they explicitly restate it.
