...
<skill name="autumn-concepts" text="Read `autumn://docs/concepts` to understand Autumn's model: Customer, Entity, Plan, Subscription, Purchase, Balance, Flag, and Billing Controls." />
...
<part file="references/actions.md" inline="true" />
...
<part file="references/timing-schedules.md" inline="true" />

<part file="references/billing-behavior.md" inline="true" />
