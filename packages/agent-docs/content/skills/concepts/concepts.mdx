...
<part file="references/customize.md" when="using customize, reading plan update previews, or representing a small diff from a base plan" />
...
<part file="references/billing-details.md" when="setting or reading a customer's billing address, tax IDs, tax exemption, or invoice custom fields" />

<part file="references/licenses.md" when="reasoning about licenses — seat plans a parent plan hands out, seat pools, assigning and releasing seats" />
