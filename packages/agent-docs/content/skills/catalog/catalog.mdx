...
<part file="references/fork-variants.md" when="deciding whether volume buckets/tiers are variants of the plan or one prepaid volume-tiered item — the tells, the trap, when variants are forced" />
...
<part file="references/fork-pooled.md" when="deciding where balances and purchases live — pooled grants, per-entity balances, customer-level packs, overage placement" />
...
<reference url="/documentation/modelling-pricing/usage-based-pricing" when="usage overage pricing" />
<reference url="/documentation/modelling-pricing/prepaid-pricing" when="prepaid quantities (seats, packs, buckets)" />
<reference url="/documentation/modelling-pricing/volume-based-tiers" when="volume-tiered prices" />
<reference url="/documentation/modelling-pricing/per-unit-pricing" when="$X per unit" />
<reference url="/documentation/modelling-pricing/recurring" when="billing vs reset intervals" />
<reference url="/documentation/modelling-pricing/one-off-purchases" when="one-off purchases / top-ups" />
<reference url="/documentation/modelling-pricing/auto-top-ups" when="auto-recharge" />
<reference url="/documentation/modelling-pricing/rollovers" when="carry-over" />
<reference url="/documentation/modelling-pricing/trials" when="trial details" />
<reference url="/documentation/modelling-pricing/entity-plans" when="entity plans and license attach flows" />
<reference url="/documentation/modelling-pricing/credit-systems" when="credit schemas and mappings" />
<reference url="/documentation/modelling-pricing/free-plans" when="default plans / auto-enable" />
<reference url="/documentation/modelling-pricing/add-ons" when="add-on balance stacking" />
<reference url="/documentation/modelling-pricing/plan-variants" when="what variants can change" />
...
<part file="references/rewards.md" when="creating or changing coupons, promo codes, feature grants, or referral programs" />
