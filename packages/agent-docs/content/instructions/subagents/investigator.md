...
- Every `autumn__*` tool you need is already registered — never call `connection_search`. Batch your reads: every lookup you can anticipate goes in one tool batch.
