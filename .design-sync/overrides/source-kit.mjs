// forked from design-sync lib/source-kit.mjs — statically imports ./dts.mjs, which
// bypasses loadLib and so never picks up the dts.mjs fork; repointed at the override.
