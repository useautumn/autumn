...
| 5 | Semantics to port: newest-bucket-first unwind, vanished bucket after an upgrade, usage windows, graduated credits | open |
...
Next: question 5, the refund rules to port.
