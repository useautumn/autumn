      ...
      <div className="relative">
        ...
        >
          ...
          <SelectPrimitive.Icon asChild>
            <ChevronDownIcon
              className={cn("size-4 opacity-0", iconClassName)}
            />
