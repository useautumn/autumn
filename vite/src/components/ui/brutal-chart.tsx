...
const ChartStyle = ({ id, config }: { id: string; config: BrutalChartConfig }) => {
...
export {
  ChartContainer as BrutalChartContainer,
  ChartTooltip as BrutalChartTooltip,
  ChartTooltipContent as BrutalChartTooltipContent,
  ChartLegend as BrutalChartLegend,
  ChartLegendContent as BrutalChartLegendContent,
  ChartStyle as BrutalChartStyle,
}