...
import { Ticket, Package, Gift, Flag } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 h-fit relative w-full text-sm">
        ...
        >
          <TabsList className="text-t2 gap-8 px-8">
          ...
          <TabsContent value="features">
            ...
            <div className="px-10">
              <h2>Features content coming soon</h2>
            </div>
          </TabsContent>
          ...
          <TabsContent value="rewards">
            <div className="flex flex-col gap-16">
              ...
              <div>
                <div className=" z-10 border-y bg-stone-100 px-10 h-10 flex justify-between items-center mt-6 whitespace-nowrap">
                  <div className="flex items-center gap-2">
