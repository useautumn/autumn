	...
	return (
		<Tooltip>
			...
			<TooltipContent className="max-w-xs">
				These plans share the same Stripe product. Stripe only allows coupons to
				be scoped to a product, so a discount on one applies to all of them. To
				target just one plan,{" "}
				<Link
					className="underline"
