...
export const ProductProps = () => {
	...
	const [_defaultOpen, _setDefaultOpen] = React.useState(false);
	const [_defaultTrialOpen, _setDefaultTrialOpen] = React.useState(false);
	const [_addOnOpen, _setAddOnOpen] = React.useState(false);
	const [groupModalOpen, setGroupModalOpen] = React.useState(false);
	const [tempGroup, setTempGroup] = React.useState(product.group || "");
	const [_archivedOpen, _setArchivedOpen] = React.useState(false);
		...
		<div className="flex justify-between gap-4 w-full whitespace-nowrap">
			<div className="flex flex-col w-full gap-4">
				<div className="flex items-center w-full justify-between gap-4 h-4">
					<p className="text-xs text-t3 font-medium text-center">Product ID</p>
            ...
            "
				...
				<div className="flex items-center w-full justify-between h-4">
					<div className="flex items-center gap-2">
						...
						<InfoTooltip>
							<p>
								This product is an add-on that can be bought together with your
