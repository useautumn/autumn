 ...
 * persist via set_plan_license; inside a customize editor (attach / update
 ...
 * save reads the full set and sends it as the payload's `licenses` override.
 */
...
/** The full license set as currently edited; [] when no cards are mounted. */
export const collectCustomizedLicenses = (
	store: LicenseCollectorStore,
): CustomizePlanLicense[] =>
	Object.values(store.getState().entries).map((entry) => entry.get());
