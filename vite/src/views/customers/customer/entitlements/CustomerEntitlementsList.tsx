			...
			{filteredEntitlements.length === 0 ? (
				...
				<>
					...
					>
						...
						{showEntityView && (
							<Item className="col-span-3">Entity</Item>
						)}
					...
					return (
						...
						>
							...
							<Item className="col-span-3">
								<div className="flex items-center gap-2 max-w-[150px] truncate text-t3">
									...
									{customer.products.find(
										(p: any) =>
											p.id === cusEnt.customer_product_id
									)?.status === "expired" && (
										<Badge
											variant="status"
											className="bg-black"
							...
							<Item className="col-span-2 text-xs text-t3">
								{
									formatUnixToDateTime(cusEnt.next_reset_at)
										.date
								}{" "}
								{
									formatUnixToDateTime(cusEnt.next_reset_at)
