...
- Some legacy code uses abbrevations for variable names. Don't do this. Use full words. Example: `cusProduct` -> `customerProduct`. Widely accepted conventions like `ctx` are acceptable.
