...
class Billing(BaseSDK):
    def attach(
        ...
        *,
        ...
        free_trial: OptionalNullable[
            Union[models.AttachFreeTrialParams, models.AttachFreeTrialParamsTypedDict]
        ] = UNSET,
        customize: Optional[
        ...
        billing_cycle_anchor: Optional[
            Union[
                models.AttachBillingCycleAnchor,
                models.AttachBillingCycleAnchorTypedDict,
            ]
        ] = None,
        ...
        carry_over_balances: Optional[
            Union[
                models.AttachCarryOverBalances, models.AttachCarryOverBalancesTypedDict
            ]
        ] = None,
        ...
        request = models.AttachParams(
            ...
            free_trial=utils.get_pydantic_model(
                free_trial, OptionalNullable[models.AttachFreeTrialParams]
            ),
            ...
            carry_over_balances=utils.get_pydantic_model(
                carry_over_balances, Optional[models.AttachCarryOverBalances]
            ),
    ...
    def preview_attach(
        ...
        *,
        ...
        free_trial: OptionalNullable[
            Union[
                models.PreviewAttachFreeTrialParams,
                models.PreviewAttachFreeTrialParamsTypedDict,
            ]
        ] = UNSET,
        customize: Optional[
        ...
        billing_cycle_anchor: Optional[
            Union[
                models.PreviewAttachBillingCycleAnchor,
                models.PreviewAttachBillingCycleAnchorTypedDict,
            ]
        ] = None,
        ...
        carry_over_balances: Optional[
            Union[
                models.PreviewAttachCarryOverBalances,
                models.PreviewAttachCarryOverBalancesTypedDict,
            ]
        ] = None,
        carry_over_usages: Optional[
            Union[
                models.PreviewAttachCarryOverUsages,
        ...
        request = models.PreviewAttachParams(
            ...
            version=version,
            free_trial=utils.get_pydantic_model(
                free_trial, OptionalNullable[models.PreviewAttachFreeTrialParams]
            ),
            customize=utils.get_pydantic_model(
            ...
            processor_subscription_id=processor_subscription_id,
            carry_over_balances=utils.get_pydantic_model(
                carry_over_balances, Optional[models.PreviewAttachCarryOverBalances]
            ),
            carry_over_usages=utils.get_pydantic_model(
    ...
    def update(
        ...
        *,
        ...
        free_trial: OptionalNullable[
            Union[
                models.BillingUpdateFreeTrialParams,
                models.BillingUpdateFreeTrialParamsTypedDict,
            ]
        ] = UNSET,
        customize: Optional[
        ...
        billing_cycle_anchor: Optional[
            Union[
                models.BillingUpdateBillingCycleAnchor,
                models.BillingUpdateBillingCycleAnchorTypedDict,
            ]
        ] = None,
        no_billing_changes: Optional[bool] = None,
        ...
        request = models.UpdateSubscriptionParams(
            ...
            version=version,
            free_trial=utils.get_pydantic_model(
                free_trial, OptionalNullable[models.BillingUpdateFreeTrialParams]
            ),
            customize=utils.get_pydantic_model(
    ...
    def preview_update(
        ...
        *,
        ...
        free_trial: OptionalNullable[
            Union[
                models.PreviewUpdateFreeTrialParams,
                models.PreviewUpdateFreeTrialParamsTypedDict,
            ]
        ] = UNSET,
        customize: Optional[
        ...
        billing_cycle_anchor: Optional[
            Union[
                models.PreviewUpdateBillingCycleAnchor,
                models.PreviewUpdateBillingCycleAnchorTypedDict,
            ]
        ] = None,
        no_billing_changes: Optional[bool] = None,
        ...
        request = models.PreviewUpdateParams(
            ...
            version=version,
            free_trial=utils.get_pydantic_model(
                free_trial, OptionalNullable[models.PreviewUpdateFreeTrialParams]
            ),
            customize=utils.get_pydantic_model(
    ...
    def setup_payment(
        ...
        *,
        ...
        free_trial: OptionalNullable[
            Union[
                models.SetupPaymentFreeTrialParams,
                models.SetupPaymentFreeTrialParamsTypedDict,
            ]
        ] = UNSET,
        customize: Optional[
        ...
        billing_cycle_anchor: Optional[
            Union[
                models.SetupPaymentBillingCycleAnchor,
                models.SetupPaymentBillingCycleAnchorTypedDict,
            ]
        ] = None,
        starts_at: Optional[int] = None,
        ends_at: Optional[int] = None,
        ...
        carry_over_balances: Optional[
            Union[
                models.SetupPaymentCarryOverBalances,
                models.SetupPaymentCarryOverBalancesTypedDict,
            ]
        ] = None,
        carry_over_usages: Optional[
            Union[
                models.SetupPaymentCarryOverUsages,
        ...
        request = models.SetupPaymentParams(
            ...
            version=version,
            free_trial=utils.get_pydantic_model(
                free_trial, OptionalNullable[models.SetupPaymentFreeTrialParams]
            ),
            customize=utils.get_pydantic_model(
            ...
            processor_subscription_id=processor_subscription_id,
            carry_over_balances=utils.get_pydantic_model(
                carry_over_balances, Optional[models.SetupPaymentCarryOverBalances]
            ),
            carry_over_usages=utils.get_pydantic_model(
    ...
    def verify(
        ...
        *,
        ...
        r"""Checks a customer's Stripe subscriptions against Autumn's record of their plans and reports any drift. Read-only: it never changes Autumn or Stripe.
        ...
        :param customer_id: Autumn customer whose Stripe subscriptions should be checked against Autumn's customer_products.
        :param subscription_ids: Optional whitelist of Stripe subscription IDs to verify. Defaults to every subscription linked to the customer's plans, plus any other active Stripe subscription on the customer, which is reported as not linked to Autumn.
        :param strict: When true, report missing usage-based items and unexpected metered Stripe items. Defaults to false.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.VerifyGlobals(
                x_api_version=self.sdk_configuration.globals.x_api_version,
            ),
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.VerifyParams
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.VerifyResponse, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.AutumnDefaultError(
                "API error occurred", http_res, http_res_text
