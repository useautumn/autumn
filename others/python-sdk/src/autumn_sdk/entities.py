...
class Entities(BaseSDK):
    def create(
        ...
        *,
        ...
        :param billing_controls: Billing controls for the entity.
    ...
    def list(
        ...
        *,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.ListEntitiesGlobals(
                x_api_version=self.sdk_configuration.globals.x_api_version,
            ),
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
    ...
    def update(
        ...
        *,
        ...
        r"""Updates an existing entity and returns the refreshed entity object.

        Use this to change entity billing controls or other mutable entity fields after the entity has already been created.

        :param entity_id: The ID of the entity.
        :param customer_id: The ID of the customer that owns the entity.
        :param billing_controls: Billing controls to replace on the entity.
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.UpdateEntityGlobals(
                x_api_version=self.sdk_configuration.globals.x_api_version,
            ),
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.UpdateEntityParams
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
