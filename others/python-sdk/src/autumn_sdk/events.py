...
class Events(BaseSDK):
    ...
    def aggregate(
        ...
        *,
        ...
        :param group_by: Property to group events by (e.g. \"properties.region\"), or \"$customer_id\" / \"$entity_id\" / \"$plan_id\" to group by those columns. When aggregate_on is \"deducted\", \"$feature_id\" groups deductions by the tracked feature that consumed each balance.
