...
class Logs(BaseSDK):
    def search(
        ...
        *,
        ...
        range: Optional[
            Union[models.SearchLogsRange, models.SearchLogsRangeTypedDict]
        ] = None,
        ...
        request = models.SearchRequestLogsParams(
            query=query,
            range=utils.get_pydantic_model(range, Optional[models.SearchLogsRange]),
            limit=limit,
        )
        ...
        req = self._build_request(
            ...
            _globals=models.SearchRequestLogsGlobals(
                x_api_version=self.sdk_configuration.globals.x_api_version,
            ),
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.SearchRequestLogsParams
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="searchRequestLogs",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.SearchRequestLogsResponse, http_res)
