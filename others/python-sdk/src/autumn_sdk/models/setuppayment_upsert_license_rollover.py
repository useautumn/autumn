...
class SetupPaymentFreeTrialParams(BaseModel):
    ...
    on_end: Optional[SetupPaymentOnEnd] = "bill"
    r"""Behavior when the trial ends. 'bill' charges the customer (default). 'revert' expires the trial and restores the customer's previous plan."""
...
class SetupPaymentItemThresholdBillingTypedDict(TypedDict):
    threshold: float


class SetupPaymentItemThresholdBilling(BaseModel):
    threshold: float
...
SetupPaymentItemDuration = Literal[
    "day",
    "week",
    "month",
    "year",
...
class SetupPaymentItemExpiryTypedDict(TypedDict):
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""

    duration: SetupPaymentItemDuration
    length: float


class SetupPaymentItemExpiry(BaseModel):
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class SetupPaymentItemProviderMarkupsTypedDict(TypedDict):
    markup: float


class SetupPaymentItemProviderMarkups(BaseModel):
    markup: float


class SetupPaymentItemModelMarkupsTypedDict(TypedDict):
    markup: NotRequired[float]
    input_cost: NotRequired[float]
    output_cost: NotRequired[float]


class SetupPaymentItemModelMarkups(BaseModel):
...
class SetupPaymentItemMarkupsTypedDict(TypedDict):
    ...
    provider_markups: NotRequired[
        Nullable[Dict[str, SetupPaymentItemProviderMarkupsTypedDict]]
    ]
    r"""Per-provider markup percentages for customers on this plan."""
    model_markups: NotRequired[
        Nullable[Dict[str, SetupPaymentItemModelMarkupsTypedDict]]
    ]
    r"""Per-model markup overrides for customers on this plan."""


class SetupPaymentItemMarkups(BaseModel):
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""

    default_markup: Optional[float] = None
    r"""Default percentage markup for customers on this plan. Use -100 to make usage free."""

    provider_markups: OptionalNullable[Dict[str, SetupPaymentItemProviderMarkups]] = (
        UNSET
    )
    r"""Per-provider markup percentages for customers on this plan."""

    model_markups: OptionalNullable[Dict[str, SetupPaymentItemModelMarkups]] = UNSET
    r"""Per-model markup overrides for customers on this plan."""
...
class SetupPaymentItemFeatureOverrideTypedDict(TypedDict):
    ...
    markups: NotRequired[SetupPaymentItemMarkupsTypedDict]
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class SetupPaymentItemFeatureOverride(BaseModel):
    ...
    markups: Optional[SetupPaymentItemMarkups] = None
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class SetupPaymentItemPlanItemTypedDict(TypedDict):
    ...
    threshold_billing: NotRequired[Nullable[SetupPaymentItemThresholdBillingTypedDict]]
    ...
    r"""Rollover config for unused units. If set, unused included units carry over."""
    expiry: NotRequired[SetupPaymentItemExpiryTypedDict]
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class SetupPaymentItemPlanItem(BaseModel):
    ...
    threshold_billing: OptionalNullable[SetupPaymentItemThresholdBilling] = UNSET
    r"""Bills this many feature units when outstanding overage reaches it."""
    ...
    expiry: Optional[SetupPaymentItemExpiry] = None
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class SetupPaymentAddItemThresholdBillingTypedDict(TypedDict):
    threshold: float


class SetupPaymentAddItemThresholdBilling(BaseModel):
    threshold: float
...
SetupPaymentAddItemDuration = Literal[
    "day",
    "week",
    "month",
    "year",
...
class SetupPaymentAddItemExpiryTypedDict(TypedDict):
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""

    duration: SetupPaymentAddItemDuration
    length: float


class SetupPaymentAddItemExpiry(BaseModel):
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class SetupPaymentAddItemProviderMarkupsTypedDict(TypedDict):
    markup: float


class SetupPaymentAddItemProviderMarkups(BaseModel):
    markup: float


class SetupPaymentAddItemModelMarkupsTypedDict(TypedDict):
    markup: NotRequired[float]
    input_cost: NotRequired[float]
    output_cost: NotRequired[float]


class SetupPaymentAddItemModelMarkups(BaseModel):
    markup: Optional[float] = None
...
class SetupPaymentAddItemMarkupsTypedDict(TypedDict):
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""

    default_markup: NotRequired[float]
    r"""Default percentage markup for customers on this plan. Use -100 to make usage free."""
    provider_markups: NotRequired[
        Nullable[Dict[str, SetupPaymentAddItemProviderMarkupsTypedDict]]
    ]
    r"""Per-provider markup percentages for customers on this plan."""
    model_markups: NotRequired[
        Nullable[Dict[str, SetupPaymentAddItemModelMarkupsTypedDict]]
    ]
    r"""Per-model markup overrides for customers on this plan."""


class SetupPaymentAddItemMarkups(BaseModel):
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
    ...
    provider_markups: OptionalNullable[
        Dict[str, SetupPaymentAddItemProviderMarkups]
    ] = UNSET
    r"""Per-provider markup percentages for customers on this plan."""

    model_markups: OptionalNullable[Dict[str, SetupPaymentAddItemModelMarkups]] = UNSET
    r"""Per-model markup overrides for customers on this plan."""
...
class SetupPaymentAddItemFeatureOverrideTypedDict(TypedDict):
    ...
    r"""For credit system features: replaces the feature's credit_schema entirely for customers on this plan."""
    markups: NotRequired[SetupPaymentAddItemMarkupsTypedDict]
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class SetupPaymentAddItemFeatureOverride(BaseModel):
    ...
    markups: Optional[SetupPaymentAddItemMarkups] = None
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class SetupPaymentAddItemPlanItemTypedDict(TypedDict):
    ...
    threshold_billing: NotRequired[
        Nullable[SetupPaymentAddItemThresholdBillingTypedDict]
    ]
    r"""Bills this many feature units when outstanding overage reaches it."""
    included: NotRequired[float]
    r"""Number of free units included. Balance resets to this each interval for consumable features."""
    ...
    r"""Rollover config for unused units. If set, unused included units carry over."""
    expiry: NotRequired[SetupPaymentAddItemExpiryTypedDict]
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class SetupPaymentAddItemPlanItem(BaseModel):
    ...
    threshold_billing: OptionalNullable[SetupPaymentAddItemThresholdBilling] = UNSET
    r"""Bills this many feature units when outstanding overage reaches it."""
    ...
    expiry: Optional[SetupPaymentAddItemExpiry] = None
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class SetupPaymentCustomizeFreeTrialParams(BaseModel):
    ...
    on_end: Optional[SetupPaymentCustomizeOnEnd] = "bill"
    r"""Behavior when the trial ends. 'bill' charges the customer (default). 'revert' expires the trial and restores the customer's previous plan."""
...
SetupPaymentAutoTopupInterval = Literal[
    "hour",
    "day",
    "week",
    "month",
...
class SetupPaymentUpsertLicenseThresholdBillingTypedDict(TypedDict):
    threshold: float


class SetupPaymentUpsertLicenseThresholdBilling(BaseModel):
    threshold: float
