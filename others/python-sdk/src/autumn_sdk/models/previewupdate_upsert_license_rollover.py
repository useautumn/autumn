...
class PreviewUpdateFreeTrialParams(BaseModel):
    ...
    on_end: Optional[PreviewUpdateOnEnd] = "bill"
    r"""Behavior when the trial ends. 'bill' charges the customer (default). 'revert' expires the trial and restores the customer's previous plan."""
...
class PreviewUpdateItemThresholdBillingTypedDict(TypedDict):
    threshold: float


class PreviewUpdateItemThresholdBilling(BaseModel):
    threshold: float
...
PreviewUpdateItemDuration = Literal[
    "day",
    "week",
    "month",
    "year",
...
class PreviewUpdateItemExpiryTypedDict(TypedDict):
...
class PreviewUpdateItemExpiry(BaseModel):
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class PreviewUpdateItemProviderMarkupsTypedDict(TypedDict):
    markup: float


class PreviewUpdateItemProviderMarkups(BaseModel):
    markup: float


class PreviewUpdateItemModelMarkupsTypedDict(TypedDict):
    markup: NotRequired[float]
    input_cost: NotRequired[float]
    output_cost: NotRequired[float]


class PreviewUpdateItemModelMarkups(BaseModel):
...
class PreviewUpdateItemMarkupsTypedDict(TypedDict):
    ...
    provider_markups: NotRequired[
        Nullable[Dict[str, PreviewUpdateItemProviderMarkupsTypedDict]]
    ]
    r"""Per-provider markup percentages for customers on this plan."""
    model_markups: NotRequired[
        Nullable[Dict[str, PreviewUpdateItemModelMarkupsTypedDict]]
    ]
    r"""Per-model markup overrides for customers on this plan."""


class PreviewUpdateItemMarkups(BaseModel):
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""

    default_markup: Optional[float] = None
    r"""Default percentage markup for customers on this plan. Use -100 to make usage free."""

    provider_markups: OptionalNullable[Dict[str, PreviewUpdateItemProviderMarkups]] = (
        UNSET
    )
    r"""Per-provider markup percentages for customers on this plan."""

    model_markups: OptionalNullable[Dict[str, PreviewUpdateItemModelMarkups]] = UNSET
    r"""Per-model markup overrides for customers on this plan."""
...
class PreviewUpdateItemFeatureOverrideTypedDict(TypedDict):
    ...
    markups: NotRequired[PreviewUpdateItemMarkupsTypedDict]
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class PreviewUpdateItemFeatureOverride(BaseModel):
    ...
    markups: Optional[PreviewUpdateItemMarkups] = None
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class PreviewUpdateItemPlanItemTypedDict(TypedDict):
    ...
    threshold_billing: NotRequired[Nullable[PreviewUpdateItemThresholdBillingTypedDict]]
    ...
    r"""Rollover config for unused units. If set, unused included units carry over."""
    expiry: NotRequired[PreviewUpdateItemExpiryTypedDict]
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class PreviewUpdateItemPlanItem(BaseModel):
    ...
    threshold_billing: OptionalNullable[PreviewUpdateItemThresholdBilling] = UNSET
    r"""Bills this many feature units when outstanding overage reaches it."""
    ...
    expiry: Optional[PreviewUpdateItemExpiry] = None
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class PreviewUpdateAddItemThresholdBillingTypedDict(TypedDict):
    threshold: float


class PreviewUpdateAddItemThresholdBilling(BaseModel):
    threshold: float
...
PreviewUpdateAddItemDuration = Literal[
    "day",
    "week",
    "month",
    "year",
...
class PreviewUpdateAddItemExpiryTypedDict(TypedDict):
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class PreviewUpdateAddItemExpiry(BaseModel):
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class PreviewUpdateAddItemProviderMarkupsTypedDict(TypedDict):
    markup: float


class PreviewUpdateAddItemProviderMarkups(BaseModel):
    markup: float


class PreviewUpdateAddItemModelMarkupsTypedDict(TypedDict):
    markup: NotRequired[float]
    input_cost: NotRequired[float]
    output_cost: NotRequired[float]


class PreviewUpdateAddItemModelMarkups(BaseModel):
    markup: Optional[float] = None
...
class PreviewUpdateAddItemMarkupsTypedDict(TypedDict):
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""

    default_markup: NotRequired[float]
    r"""Default percentage markup for customers on this plan. Use -100 to make usage free."""
    provider_markups: NotRequired[
        Nullable[Dict[str, PreviewUpdateAddItemProviderMarkupsTypedDict]]
    ]
    r"""Per-provider markup percentages for customers on this plan."""
    model_markups: NotRequired[
        Nullable[Dict[str, PreviewUpdateAddItemModelMarkupsTypedDict]]
    ]
    r"""Per-model markup overrides for customers on this plan."""


class PreviewUpdateAddItemMarkups(BaseModel):
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
    ...
    provider_markups: OptionalNullable[
        Dict[str, PreviewUpdateAddItemProviderMarkups]
    ] = UNSET
    r"""Per-provider markup percentages for customers on this plan."""

    model_markups: OptionalNullable[Dict[str, PreviewUpdateAddItemModelMarkups]] = UNSET
    r"""Per-model markup overrides for customers on this plan."""
...
class PreviewUpdateAddItemFeatureOverrideTypedDict(TypedDict):
    ...
    r"""For credit system features: replaces the feature's credit_schema entirely for customers on this plan."""
    markups: NotRequired[PreviewUpdateAddItemMarkupsTypedDict]
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class PreviewUpdateAddItemFeatureOverride(BaseModel):
    ...
    markups: Optional[PreviewUpdateAddItemMarkups] = None
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class PreviewUpdateAddItemPlanItemTypedDict(TypedDict):
    ...
    threshold_billing: NotRequired[
        Nullable[PreviewUpdateAddItemThresholdBillingTypedDict]
    ]
    r"""Bills this many feature units when outstanding overage reaches it."""
    included: NotRequired[float]
    r"""Number of free units included. Balance resets to this each interval for consumable features."""
    ...
    r"""Rollover config for unused units. If set, unused included units carry over."""
    expiry: NotRequired[PreviewUpdateAddItemExpiryTypedDict]
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class PreviewUpdateAddItemPlanItem(BaseModel):
    ...
    threshold_billing: OptionalNullable[PreviewUpdateAddItemThresholdBilling] = UNSET
    r"""Bills this many feature units when outstanding overage reaches it."""
    ...
    expiry: Optional[PreviewUpdateAddItemExpiry] = None
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class PreviewUpdateCustomizeFreeTrialParams(BaseModel):
    ...
    on_end: Optional[PreviewUpdateCustomizeOnEnd] = "bill"
    r"""Behavior when the trial ends. 'bill' charges the customer (default). 'revert' expires the trial and restores the customer's previous plan."""
...
PreviewUpdateAutoTopupInterval = Literal[
    "hour",
    "day",
    "week",
    "month",
...
class PreviewUpdateUpsertLicenseThresholdBillingTypedDict(TypedDict):
    threshold: float


class PreviewUpdateUpsertLicenseThresholdBilling(BaseModel):
    threshold: float
