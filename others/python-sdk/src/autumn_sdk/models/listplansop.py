...
ListPlansUpsertLicenseInterval = Union[
    Literal[
        "one_off",
        "week",
        "month",
...
class ListPlansUpsertLicenseBasePriceTypedDict(TypedDict):
    r"""Base price configuration for a plan."""
...
class ListPlansUpsertLicenseBasePrice(BaseModel):
    r"""Base price configuration for a plan."""
...
class ListPlansUpsertLicensePlanItemFilterTypedDict(TypedDict):
    r"""Filter for matching plan items. All provided fields must match (AND)."""
...
class ListPlansUpsertLicensePlanItemFilter(BaseModel):
    r"""Filter for matching plan items. All provided fields must match (AND)."""
...
class ListPlansUpsertLicenseCustomizeTypedDict(TypedDict):
    price: NotRequired[Nullable[ListPlansUpsertLicenseBasePriceTypedDict]]
    add_items: NotRequired[List[ListPlansUpsertLicensePlanItemTypedDict]]
    remove_items: NotRequired[List[ListPlansUpsertLicensePlanItemFilterTypedDict]]


class ListPlansUpsertLicenseCustomize(BaseModel):
    price: OptionalNullable[ListPlansUpsertLicenseBasePrice] = UNSET

    add_items: Optional[List[ListPlansUpsertLicensePlanItem]] = None

    remove_items: Optional[List[ListPlansUpsertLicensePlanItemFilter]] = None
...
class ListPlansUpsertLicense(BaseModel):
    ...
    customize: OptionalNullable[ListPlansUpsertLicenseCustomize] = UNSET
...
class ListPlansRemoveLicenseTypedDict(TypedDict):
    license_plan_id: str


class ListPlansRemoveLicense(BaseModel):
    license_plan_id: str
...
class ListPlansCustomizeTypedDict(TypedDict):
    ...
    r"""Override the plan's billing controls (auto top-ups, spend limits, usage limits, usage alerts, overage allowed) for this customer."""
    upsert_licenses: NotRequired[List[ListPlansUpsertLicenseTypedDict]]
    ...
    remove_licenses: NotRequired[List[ListPlansRemoveLicenseTypedDict]]
...
class ListPlansCustomize(BaseModel):
    ...
    upsert_licenses: Optional[List[ListPlansUpsertLicense]] = None
    r"""License links to add or override for this customer, keyed by license_plan_id. Omitted fields inherit the plan catalog link (included defaults to 1 when the license is not in the catalog). A bare entry restores the license to pure catalog inheritance."""

    remove_licenses: Optional[List[ListPlansRemoveLicense]] = None
    r"""License links to drop, keyed by license_plan_id. Parallel to remove_items."""
