...
class UpdatePlanItemThresholdBillingRequestBodyTypedDict(TypedDict):
    threshold: float


class UpdatePlanItemThresholdBillingRequestBody(BaseModel):
    threshold: float
...
UpdatePlanItemDurationRequestBody = Literal[
    "day",
    "week",
    "month",
    "year",
...
class UpdatePlanItemExpiryRequestBodyTypedDict(TypedDict):
...
class UpdatePlanItemExpiryRequestBody(BaseModel):
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class UpdatePlanItemProviderMarkupsRequestBodyTypedDict(TypedDict):
    markup: float


class UpdatePlanItemProviderMarkupsRequestBody(BaseModel):
    markup: float


class UpdatePlanItemModelMarkupsRequestBodyTypedDict(TypedDict):
    markup: NotRequired[float]
    input_cost: NotRequired[float]
    output_cost: NotRequired[float]


class UpdatePlanItemModelMarkupsRequestBody(BaseModel):
...
class UpdatePlanItemMarkupsRequestBodyTypedDict(TypedDict):
    ...
    provider_markups: NotRequired[
        Nullable[Dict[str, UpdatePlanItemProviderMarkupsRequestBodyTypedDict]]
    ]
    r"""Per-provider markup percentages for customers on this plan."""
    model_markups: NotRequired[
        Nullable[Dict[str, UpdatePlanItemModelMarkupsRequestBodyTypedDict]]
    ]
    r"""Per-model markup overrides for customers on this plan."""


class UpdatePlanItemMarkupsRequestBody(BaseModel):
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
    ...
    provider_markups: OptionalNullable[
        Dict[str, UpdatePlanItemProviderMarkupsRequestBody]
    ] = UNSET
    r"""Per-provider markup percentages for customers on this plan."""

    model_markups: OptionalNullable[
        Dict[str, UpdatePlanItemModelMarkupsRequestBody]
    ] = UNSET
    r"""Per-model markup overrides for customers on this plan."""
...
class UpdatePlanItemFeatureOverrideRequestBodyTypedDict(TypedDict):
    ...
    markups: NotRequired[UpdatePlanItemMarkupsRequestBodyTypedDict]
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class UpdatePlanItemFeatureOverrideRequestBody(BaseModel):
    ...
    markups: Optional[UpdatePlanItemMarkupsRequestBody] = None
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class UpdatePlanItemPlanItemTypedDict(TypedDict):
    ...
    threshold_billing: NotRequired[
        Nullable[UpdatePlanItemThresholdBillingRequestBodyTypedDict]
    ]
    ...
    r"""Rollover config for unused units. If set, unused included units carry over."""
    expiry: NotRequired[UpdatePlanItemExpiryRequestBodyTypedDict]
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class UpdatePlanItemPlanItem(BaseModel):
    ...
    threshold_billing: OptionalNullable[UpdatePlanItemThresholdBillingRequestBody] = (
        UNSET
    )
    r"""Bills this many feature units when outstanding overage reaches it."""
    ...
    expiry: Optional[UpdatePlanItemExpiryRequestBody] = None
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class UpdatePlanFreeTrialParamsRequestBody(BaseModel):
    ...
    on_end: Optional[UpdatePlanOnEndRequestBody] = "bill"
    r"""Behavior when the trial ends. 'bill' charges the customer (default). 'revert' expires the trial and restores the customer's previous plan."""
...
UpdatePlanAutoTopupIntervalRequestBody = Literal[
    "hour",
    "day",
    "week",
    "month",
...
class UpdatePlanVariantThresholdBillingTypedDict(TypedDict):
    threshold: float


class UpdatePlanVariantThresholdBilling(BaseModel):
    threshold: float
