...
CreateEntityUsageLimitPropertiesTypedDict = TypeAliasType(
    "CreateEntityUsageLimitPropertiesTypedDict", Union[str, float, bool]
)


CreateEntityUsageLimitProperties = TypeAliasType(
    "CreateEntityUsageLimitProperties", Union[str, float, bool]
)


class CreateEntityUsageLimitFilterRequestBodyTypedDict(TypedDict):
    r"""When set, only usage from events whose properties match counts toward this cap. Omit to count all usage of the feature."""

    properties: Dict[str, CreateEntityUsageLimitPropertiesTypedDict]


class CreateEntityUsageLimitFilterRequestBody(BaseModel):
    r"""When set, only usage from events whose properties match counts toward this cap. Omit to count all usage of the feature."""

    properties: Dict[str, CreateEntityUsageLimitProperties]
...
class CreateEntityUsageLimitRequestBodyTypedDict(TypedDict):
    ...
    r"""Window alignment. 'billing_cycle' phases the interval to the customer's renewal time; 'utc' aligns to the UTC calendar."""
    filter_: NotRequired[CreateEntityUsageLimitFilterRequestBodyTypedDict]
    r"""When set, only usage from events whose properties match counts toward this cap. Omit to count all usage of the feature."""
...
class CreateEntityUsageLimitRequestBody(BaseModel):
    ...
    filter_: Annotated[
        Optional[CreateEntityUsageLimitFilterRequestBody],
...
CreateEntityBasisRequestBody = Literal[
    "balance",
    "included",
    "recurring",
    "usage_limit",
...
CreateEntityUsageAlertPropertiesTypedDict = TypeAliasType(
    "CreateEntityUsageAlertPropertiesTypedDict", Union[str, float, bool]
)


CreateEntityUsageAlertProperties = TypeAliasType(
    "CreateEntityUsageAlertProperties", Union[str, float, bool]
)


class CreateEntityUsageAlertFilterRequestBodyTypedDict(TypedDict):
    r"""Only valid with basis usage_limit. Points the alert at the usage limit carrying the same filter."""

    properties: Dict[str, CreateEntityUsageAlertPropertiesTypedDict]


class CreateEntityUsageAlertFilterRequestBody(BaseModel):
    r"""Only valid with basis usage_limit. Points the alert at the usage limit carrying the same filter."""

    properties: Dict[str, CreateEntityUsageAlertProperties]
...
class CreateEntityUsageAlertRequestBodyTypedDict(TypedDict):
    ...
    basis: NotRequired[CreateEntityBasisRequestBody]
    r"""What 100% means. balance: every grant on the feature. included: the plan allowance only. recurring: grants that reset. usage_limit: the cap of the usage limit with the same feature and filter."""
    filter_: NotRequired[CreateEntityUsageAlertFilterRequestBodyTypedDict]
    r"""Only valid with basis usage_limit. Points the alert at the usage limit carrying the same filter."""
...
class CreateEntityUsageAlertRequestBody(BaseModel):
    ...
    basis: Optional[CreateEntityBasisRequestBody] = "balance"
    r"""What 100% means. balance: every grant on the feature. included: the plan allowance only. recurring: grants that reset. usage_limit: the cap of the usage limit with the same feature and filter."""

    filter_: Annotated[
        Optional[CreateEntityUsageAlertFilterRequestBody],
        pydantic.Field(alias="filter"),
    ] = None
    r"""Only valid with basis usage_limit. Points the alert at the usage limit carrying the same filter."""
...
class CreateEntityDimensions6TypedDict(TypedDict):
    match: Dict[str, str]
...
class CreateEntityDimensions6(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
...
CreateEntityDimensionsToEnum3 = Literal["inf",]


CreateEntityDimensionsToUnion3TypedDict = TypeAliasType(
    "CreateEntityDimensionsToUnion3TypedDict",
    Union[float, CreateEntityDimensionsToEnum3],
)
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


CreateEntityDimensionsToUnion3 = TypeAliasType(
    "CreateEntityDimensionsToUnion3", Union[float, CreateEntityDimensionsToEnum3]
)
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


class CreateEntityDimensionsTier3TypedDict(TypedDict):
    to: CreateEntityDimensionsToUnion3TypedDict
    r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""
    credit_cost: float
    r"""Credits consumed per billing-unit group within this tier."""


class CreateEntityDimensionsTier3(BaseModel):
    to: CreateEntityDimensionsToUnion3
    r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""
...
class CreateEntityDimensions5TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
    tiers: List[CreateEntityDimensionsTier3TypedDict]
    priority: NotRequired[int]
    r"""Breaks ties between dimensions that match the same number of keys. Higher wins."""
    tier_behavior: Literal["graduated"]


class CreateEntityDimensions5(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""

    tiers: List[CreateEntityDimensionsTier3]
...
CreateEntityDimensionsUnion3TypedDict = TypeAliasType(
    "CreateEntityDimensionsUnion3TypedDict",
    Union[CreateEntityDimensions6TypedDict, CreateEntityDimensions5TypedDict],
)


CreateEntityDimensionsUnion3 = TypeAliasType(
    "CreateEntityDimensionsUnion3",
    Union[CreateEntityDimensions6, CreateEntityDimensions5],
)


class CreateEntityMultipliers3TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
...
class CreateEntityMultipliers3(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
...
class CreateEntityCreditSchema3TypedDict(TypedDict):
    credit_cost: float
...
class CreateEntityCreditSchema3(BaseModel):
    ...
    dimensions: Optional[Dict[str, CreateEntityDimensionsUnion3]] = None
    r"""Named rates chosen by event properties. The most specific match sets the rate; with no match the item's own rate applies."""

    multipliers: Optional[Dict[str, CreateEntityMultipliers3]] = None
    r"""Named adjustments chosen by event properties. Every match applies: factors multiply, then adds are summed."""
...
class CreateEntityDimensions4TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
    credit_cost: float
    r"""Credits consumed per billing-unit group when this dimension matches."""
...
class CreateEntityDimensions4(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
...
CreateEntityDimensionsToEnum2 = Literal["inf",]


CreateEntityDimensionsToUnion2TypedDict = TypeAliasType(
    "CreateEntityDimensionsToUnion2TypedDict",
    Union[float, CreateEntityDimensionsToEnum2],
)
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


CreateEntityDimensionsToUnion2 = TypeAliasType(
    "CreateEntityDimensionsToUnion2", Union[float, CreateEntityDimensionsToEnum2]
)
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


class CreateEntityDimensionsTier2TypedDict(TypedDict):
    to: CreateEntityDimensionsToUnion2TypedDict
    r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""
    credit_cost: float
    r"""Credits consumed per billing-unit group within this tier."""


class CreateEntityDimensionsTier2(BaseModel):
    to: CreateEntityDimensionsToUnion2
    r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""
...
class CreateEntityDimensions3TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
    tiers: List[CreateEntityDimensionsTier2TypedDict]
    priority: NotRequired[int]
    r"""Breaks ties between dimensions that match the same number of keys. Higher wins."""
    tier_behavior: Literal["graduated"]


class CreateEntityDimensions3(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""

    tiers: List[CreateEntityDimensionsTier2]
...
CreateEntityDimensionsUnion2TypedDict = TypeAliasType(
    "CreateEntityDimensionsUnion2TypedDict",
    Union[CreateEntityDimensions4TypedDict, CreateEntityDimensions3TypedDict],
)


CreateEntityDimensionsUnion2 = TypeAliasType(
    "CreateEntityDimensionsUnion2",
    Union[CreateEntityDimensions4, CreateEntityDimensions3],
)


class CreateEntityMultipliers2TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
    factor: NotRequired[float]
    r"""Multiplies the matched rate. All matching multipliers stack."""
...
class CreateEntityMultipliers2(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
...
class CreateEntityCreditSchema2TypedDict(TypedDict):
    ...
    billing_units: NotRequired[float]
    r"""Number of metered-feature units priced together. Defaults to one when omitted."""
    dimensions: NotRequired[Dict[str, CreateEntityDimensionsUnion2TypedDict]]
    r"""Named rates chosen by event properties. The most specific match sets the rate; with no match the item's own rate applies."""
    multipliers: NotRequired[Dict[str, CreateEntityMultipliers2TypedDict]]
    r"""Named adjustments chosen by event properties. Every match applies: factors multiply, then adds are summed."""


class CreateEntityCreditSchema2(BaseModel):
    metered_feature_id: str
    r"""ID of the metered feature that draws from this credit system."""
    ...
    dimensions: Optional[Dict[str, CreateEntityDimensionsUnion2]] = None
    r"""Named rates chosen by event properties. The most specific match sets the rate; with no match the item's own rate applies."""

    multipliers: Optional[Dict[str, CreateEntityMultipliers2]] = None
    r"""Named adjustments chosen by event properties. Every match applies: factors multiply, then adds are summed."""
...
class CreateEntityDimensions2TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
    credit_cost: float
    r"""Credits consumed per billing-unit group when this dimension matches."""
...
class CreateEntityDimensions2(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
...
CreateEntityDimensionsToEnum1 = Literal["inf",]


CreateEntityDimensionsToUnion1TypedDict = TypeAliasType(
    "CreateEntityDimensionsToUnion1TypedDict",
    Union[float, CreateEntityDimensionsToEnum1],
)
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


CreateEntityDimensionsToUnion1 = TypeAliasType(
    "CreateEntityDimensionsToUnion1", Union[float, CreateEntityDimensionsToEnum1]
)
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


class CreateEntityDimensionsTier1TypedDict(TypedDict):
    to: CreateEntityDimensionsToUnion1TypedDict
    r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""
    credit_cost: float
    r"""Credits consumed per billing-unit group within this tier."""


class CreateEntityDimensionsTier1(BaseModel):
    to: CreateEntityDimensionsToUnion1
    r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""
...
class CreateEntityDimensions1TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
    tiers: List[CreateEntityDimensionsTier1TypedDict]
    priority: NotRequired[int]
    r"""Breaks ties between dimensions that match the same number of keys. Higher wins."""
    tier_behavior: Literal["graduated"]


class CreateEntityDimensions1(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""

    tiers: List[CreateEntityDimensionsTier1]
...
CreateEntityDimensionsUnion1TypedDict = TypeAliasType(
    "CreateEntityDimensionsUnion1TypedDict",
    Union[CreateEntityDimensions2TypedDict, CreateEntityDimensions1TypedDict],
)


CreateEntityDimensionsUnion1 = TypeAliasType(
    "CreateEntityDimensionsUnion1",
    Union[CreateEntityDimensions2, CreateEntityDimensions1],
)


class CreateEntityMultipliers1TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
    factor: NotRequired[float]
    r"""Multiplies the matched rate. All matching multipliers stack."""
...
class CreateEntityMultipliers1(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
...
CreateEntityToEnum = Literal["inf",]


CreateEntityToUnionTypedDict = TypeAliasType(
    "CreateEntityToUnionTypedDict", Union[float, CreateEntityToEnum]
)
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


CreateEntityToUnion = TypeAliasType(
    "CreateEntityToUnion", Union[float, CreateEntityToEnum]
)
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


class CreateEntityTierTypedDict(TypedDict):
    to: CreateEntityToUnionTypedDict
    r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""
    credit_cost: float
    r"""Credits consumed per billing-unit group within this tier."""
...
class CreateEntityCreditSchema1TypedDict(TypedDict):
    metered_feature_id: str
    r"""ID of the metered feature that draws from this credit system."""
    tiers: List[CreateEntityTierTypedDict]
    billing_units: NotRequired[float]
    r"""Number of metered-feature units priced together. Defaults to one when omitted."""
    dimensions: NotRequired[Dict[str, CreateEntityDimensionsUnion1TypedDict]]
    r"""Named rates chosen by event properties. The most specific match sets the rate; with no match the item's own rate applies."""
    multipliers: NotRequired[Dict[str, CreateEntityMultipliers1TypedDict]]
    r"""Named adjustments chosen by event properties. Every match applies: factors multiply, then adds are summed."""
    tier_behavior: Literal["graduated"]


class CreateEntityCreditSchema1(BaseModel):
    metered_feature_id: str
    r"""ID of the metered feature that draws from this credit system."""

    tiers: List[CreateEntityTier]

    billing_units: Optional[float] = None
    r"""Number of metered-feature units priced together. Defaults to one when omitted."""

    dimensions: Optional[Dict[str, CreateEntityDimensionsUnion1]] = None
    r"""Named rates chosen by event properties. The most specific match sets the rate; with no match the item's own rate applies."""

    multipliers: Optional[Dict[str, CreateEntityMultipliers1]] = None
    r"""Named adjustments chosen by event properties. Every match applies: factors multiply, then adds are summed."""
...
CreateEntityCreditSchemaUnionTypedDict = TypeAliasType(
...
CreateEntityCreditSchemaUnion = TypeAliasType(
    "CreateEntityCreditSchemaUnion",
    Union[
        CreateEntityCreditSchema2, CreateEntityCreditSchema3, CreateEntityCreditSchema1
    ],
)
...
class CreateEntityStripeTypedDict(TypedDict):
...
class CreateEntityStripe(BaseModel):
...
class CreateEntityProcessorsTypedDict(TypedDict):
    r"""Processor mappings for this feature. Present when a Stripe product or meter is set."""

    stripe: NotRequired[CreateEntityStripeTypedDict]


class CreateEntityProcessors(BaseModel):
    r"""Processor mappings for this feature. Present when a Stripe product or meter is set."""

    stripe: Optional[CreateEntityStripe] = None
...
class CreateEntityFeatureTypedDict(TypedDict):
    ...
    credit_schema: NotRequired[List[CreateEntityCreditSchemaUnionTypedDict]]
    ...
    r"""Display names for the feature in billing UI and customer-facing components."""
    processors: NotRequired[CreateEntityProcessorsTypedDict]
    r"""Processor mappings for this feature. Present when a Stripe product or meter is set."""
...
class CreateEntityFeature(BaseModel):
    ...
    credit_schema: Optional[List[CreateEntityCreditSchemaUnion]] = None
    r"""For classic credit systems: maps metered features to flat or graduated credit costs."""
    ...
    processors: Optional[CreateEntityProcessors] = None
    r"""Processor mappings for this feature. Present when a Stripe product or meter is set."""
...
class CreateEntityUsageLimitFilterResponseTypedDict(TypedDict):
    r"""When set, only usage from events whose properties match counts toward this cap. Omit to count all usage of the feature."""

    properties: Dict[str, str]


class CreateEntityUsageLimitFilterResponse(BaseModel):
    r"""When set, only usage from events whose properties match counts toward this cap. Omit to count all usage of the feature."""
...
class CreateEntityUsageLimitResponseTypedDict(TypedDict):
    ...
    r"""Window alignment. 'billing_cycle' phases the interval to the customer's renewal time; 'utc' aligns to the UTC calendar."""
    filter_: NotRequired[CreateEntityUsageLimitFilterResponseTypedDict]
    r"""When set, only usage from events whose properties match counts toward this cap. Omit to count all usage of the feature."""
...
class CreateEntityUsageLimitResponse(BaseModel):
    ...
    filter_: Annotated[
        Optional[CreateEntityUsageLimitFilterResponse], pydantic.Field(alias="filter")
    ] = None
    r"""When set, only usage from events whose properties match counts toward this cap. Omit to count all usage of the feature."""
...
CreateEntityBasisResponse = Union[
    Literal[
        "balance",
        "included",
        "recurring",
...
class CreateEntityUsageAlertFilterResponseTypedDict(TypedDict):
    r"""Only valid with basis usage_limit. Points the alert at the usage limit carrying the same filter."""

    properties: Dict[str, str]


class CreateEntityUsageAlertFilterResponse(BaseModel):
    r"""Only valid with basis usage_limit. Points the alert at the usage limit carrying the same filter."""
...
class CreateEntityUsageAlertResponseTypedDict(TypedDict):
    ...
    enabled: NotRequired[bool]
    r"""Whether this usage alert is enabled."""
    basis: NotRequired[CreateEntityBasisResponse]
    r"""What 100% means. balance: every grant on the feature. included: the plan allowance only. recurring: grants that reset. usage_limit: the cap of the usage limit with the same feature and filter."""
    filter_: NotRequired[CreateEntityUsageAlertFilterResponseTypedDict]
    r"""Only valid with basis usage_limit. Points the alert at the usage limit carrying the same filter."""
    name: NotRequired[str]
    r"""Optional user-defined label to distinguish multiple alerts on the same feature."""
...
class CreateEntityUsageAlertResponse(BaseModel):
    ...
    basis: Optional[CreateEntityBasisResponse] = "balance"
    r"""What 100% means. balance: every grant on the feature. included: the plan allowance only. recurring: grants that reset. usage_limit: the cap of the usage limit with the same feature and filter."""

    filter_: Annotated[
        Optional[CreateEntityUsageAlertFilterResponse], pydantic.Field(alias="filter")
    ] = None
    r"""Only valid with basis usage_limit. Points the alert at the usage limit carrying the same filter."""
...
try:
    ...
    pass
try:
    CreateEntityUsageAlertRequestBody.model_rebuild()
except NameError:
    pass
try:
    CreateEntityDimensions5.model_rebuild()
except NameError:
    pass
try:
    CreateEntityCreditSchema3.model_rebuild()
except NameError:
    pass
try:
    CreateEntityDimensions3.model_rebuild()
except NameError:
    pass
try:
    CreateEntityDimensions1.model_rebuild()
except NameError:
    pass
try:
    CreateEntityCreditSchema1.model_rebuild()
except NameError:
    pass
try:
    ...
    pass
try:
    CreateEntityUsageAlertResponse.model_rebuild()
except NameError:
    pass
