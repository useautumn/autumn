...
class VoidInvoiceGlobalsTypedDict(TypedDict):
    x_api_version: NotRequired[str]


class VoidInvoiceGlobals(BaseModel):
...
class VoidInvoiceParamsTypedDict(TypedDict):
    invoice_id: str
    r"""The Autumn invoice ID to void."""


class VoidInvoiceParams(BaseModel):
    invoice_id: str
    r"""The Autumn invoice ID to void."""


VoidInvoiceProcessorType = Union[
    Literal[
        "stripe",
        "revenuecat",
    ],
...
class VoidInvoiceEntityTypedDict(TypedDict):
    entity_id: str
...
class VoidInvoiceEntity(BaseModel):
    entity_id: str
    r"""The entity this share of the line item is attributed to"""
...
class VoidInvoiceItemTypedDict(TypedDict):
    description: str
    ...
    entities: List[VoidInvoiceEntityTypedDict]
...
class VoidInvoiceItem(BaseModel):
    description: str
    r"""Description of the invoice line item"""
    ...
    entities: List[VoidInvoiceEntity]
    r"""How this line splits by entity. Empty for customer-level lines. Only populated for invoices finalized after entity attribution shipped."""
...
class VoidInvoiceInvoiceTypedDict(TypedDict):
    plan_ids: List[str]
    ...
    processor_type: NotRequired[VoidInvoiceProcessorType]
    r"""The billing processor that owns this invoice."""
    hosted_invoice_url: NotRequired[Nullable[str]]
    r"""URL to the Stripe-hosted invoice page"""
    items: NotRequired[List[VoidInvoiceItemTypedDict]]
...
class VoidInvoiceInvoice(BaseModel):
    plan_ids: List[str]
    r"""Array of plan IDs included in this invoice"""
    ...
    processor_type: Optional[VoidInvoiceProcessorType] = "stripe"
    r"""The billing processor that owns this invoice."""

    hosted_invoice_url: OptionalNullable[str] = UNSET
    r"""URL to the Stripe-hosted invoice page"""

    items: Optional[List[VoidInvoiceItem]] = None
    r"""Line items on the invoice, one per line as shown in Stripe. Capped at 100. Empty for invoices recorded before line item storage."""
...
class VoidInvoiceResponseTypedDict(TypedDict):
    r"""OK"""

    invoice: VoidInvoiceInvoiceTypedDict
