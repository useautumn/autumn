...
class BillingUpdateFreeTrialParams(BaseModel):
    ...
    on_end: Optional[BillingUpdateOnEnd] = "bill"
    r"""Behavior when the trial ends. 'bill' charges the customer (default). 'revert' expires the trial and restores the customer's previous plan."""
...
class BillingUpdateItemThresholdBillingTypedDict(TypedDict):
    threshold: float


class BillingUpdateItemThresholdBilling(BaseModel):
    threshold: float
...
BillingUpdateItemDuration = Literal[
    "day",
    "week",
    "month",
    "year",
...
class BillingUpdateItemExpiryTypedDict(TypedDict):
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""

    duration: BillingUpdateItemDuration
    length: float


class BillingUpdateItemExpiry(BaseModel):
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class BillingUpdateItemProviderMarkupsTypedDict(TypedDict):
    markup: float


class BillingUpdateItemProviderMarkups(BaseModel):
    markup: float


class BillingUpdateItemModelMarkupsTypedDict(TypedDict):
    markup: NotRequired[float]
    input_cost: NotRequired[float]
    output_cost: NotRequired[float]


class BillingUpdateItemModelMarkups(BaseModel):
...
class BillingUpdateItemMarkupsTypedDict(TypedDict):
    ...
    provider_markups: NotRequired[
        Nullable[Dict[str, BillingUpdateItemProviderMarkupsTypedDict]]
    ]
    r"""Per-provider markup percentages for customers on this plan."""
    model_markups: NotRequired[
        Nullable[Dict[str, BillingUpdateItemModelMarkupsTypedDict]]
    ]
    r"""Per-model markup overrides for customers on this plan."""


class BillingUpdateItemMarkups(BaseModel):
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""

    default_markup: Optional[float] = None
    r"""Default percentage markup for customers on this plan. Use -100 to make usage free."""

    provider_markups: OptionalNullable[Dict[str, BillingUpdateItemProviderMarkups]] = (
        UNSET
    )
    r"""Per-provider markup percentages for customers on this plan."""

    model_markups: OptionalNullable[Dict[str, BillingUpdateItemModelMarkups]] = UNSET
    r"""Per-model markup overrides for customers on this plan."""
...
class BillingUpdateItemFeatureOverrideTypedDict(TypedDict):
    ...
    markups: NotRequired[BillingUpdateItemMarkupsTypedDict]
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class BillingUpdateItemFeatureOverride(BaseModel):
    ...
    markups: Optional[BillingUpdateItemMarkups] = None
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class BillingUpdateItemPlanItemTypedDict(TypedDict):
    ...
    threshold_billing: NotRequired[Nullable[BillingUpdateItemThresholdBillingTypedDict]]
    ...
    r"""Rollover config for unused units. If set, unused included units carry over."""
    expiry: NotRequired[BillingUpdateItemExpiryTypedDict]
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class BillingUpdateItemPlanItem(BaseModel):
    ...
    threshold_billing: OptionalNullable[BillingUpdateItemThresholdBilling] = UNSET
    r"""Bills this many feature units when outstanding overage reaches it."""
    ...
    expiry: Optional[BillingUpdateItemExpiry] = None
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class BillingUpdateAddItemThresholdBillingTypedDict(TypedDict):
    threshold: float


class BillingUpdateAddItemThresholdBilling(BaseModel):
    threshold: float
...
BillingUpdateAddItemDuration = Literal[
    "day",
    "week",
    "month",
    "year",
...
class BillingUpdateAddItemExpiryTypedDict(TypedDict):
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""

    duration: BillingUpdateAddItemDuration
    length: float


class BillingUpdateAddItemExpiry(BaseModel):
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class BillingUpdateAddItemProviderMarkupsTypedDict(TypedDict):
    markup: float


class BillingUpdateAddItemProviderMarkups(BaseModel):
    markup: float


class BillingUpdateAddItemModelMarkupsTypedDict(TypedDict):
    markup: NotRequired[float]
    input_cost: NotRequired[float]
    output_cost: NotRequired[float]


class BillingUpdateAddItemModelMarkups(BaseModel):
    markup: Optional[float] = None
...
class BillingUpdateAddItemMarkupsTypedDict(TypedDict):
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""

    default_markup: NotRequired[float]
    r"""Default percentage markup for customers on this plan. Use -100 to make usage free."""
    provider_markups: NotRequired[
        Nullable[Dict[str, BillingUpdateAddItemProviderMarkupsTypedDict]]
    ]
    r"""Per-provider markup percentages for customers on this plan."""
    model_markups: NotRequired[
        Nullable[Dict[str, BillingUpdateAddItemModelMarkupsTypedDict]]
    ]
    r"""Per-model markup overrides for customers on this plan."""


class BillingUpdateAddItemMarkups(BaseModel):
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
    ...
    provider_markups: OptionalNullable[
        Dict[str, BillingUpdateAddItemProviderMarkups]
    ] = UNSET
    r"""Per-provider markup percentages for customers on this plan."""

    model_markups: OptionalNullable[Dict[str, BillingUpdateAddItemModelMarkups]] = UNSET
    r"""Per-model markup overrides for customers on this plan."""
...
class BillingUpdateAddItemFeatureOverrideTypedDict(TypedDict):
    ...
    r"""For credit system features: replaces the feature's credit_schema entirely for customers on this plan."""
    markups: NotRequired[BillingUpdateAddItemMarkupsTypedDict]
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class BillingUpdateAddItemFeatureOverride(BaseModel):
    ...
    markups: Optional[BillingUpdateAddItemMarkups] = None
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class BillingUpdateAddItemPlanItemTypedDict(TypedDict):
    ...
    threshold_billing: NotRequired[
        Nullable[BillingUpdateAddItemThresholdBillingTypedDict]
    ]
    r"""Bills this many feature units when outstanding overage reaches it."""
    included: NotRequired[float]
    r"""Number of free units included. Balance resets to this each interval for consumable features."""
    ...
    r"""Rollover config for unused units. If set, unused included units carry over."""
    expiry: NotRequired[BillingUpdateAddItemExpiryTypedDict]
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class BillingUpdateAddItemPlanItem(BaseModel):
    ...
    threshold_billing: OptionalNullable[BillingUpdateAddItemThresholdBilling] = UNSET
    r"""Bills this many feature units when outstanding overage reaches it."""
    ...
    expiry: Optional[BillingUpdateAddItemExpiry] = None
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class BillingUpdateCustomizeFreeTrialParams(BaseModel):
    ...
    on_end: Optional[BillingUpdateCustomizeOnEnd] = "bill"
    r"""Behavior when the trial ends. 'bill' charges the customer (default). 'revert' expires the trial and restores the customer's previous plan."""
...
BillingUpdateAutoTopupInterval = Literal[
    "hour",
    "day",
    "week",
    "month",
...
class BillingUpdateUpsertLicenseThresholdBillingTypedDict(TypedDict):
    threshold: float


class BillingUpdateUpsertLicenseThresholdBilling(BaseModel):
    threshold: float
