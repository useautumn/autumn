...
class CreatePlanItemThresholdBillingRequestBodyTypedDict(TypedDict):
    threshold: float


class CreatePlanItemThresholdBillingRequestBody(BaseModel):
    threshold: float
...
CreatePlanItemDurationRequestBody = Literal[
    "day",
    "week",
    "month",
    "year",
...
class CreatePlanItemExpiryRequestBodyTypedDict(TypedDict):
...
class CreatePlanItemExpiryRequestBody(BaseModel):
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class CreatePlanItemProviderMarkupsRequestBodyTypedDict(TypedDict):
    markup: float


class CreatePlanItemProviderMarkupsRequestBody(BaseModel):
    markup: float


class CreatePlanItemModelMarkupsRequestBodyTypedDict(TypedDict):
    markup: NotRequired[float]
    input_cost: NotRequired[float]
    output_cost: NotRequired[float]


class CreatePlanItemModelMarkupsRequestBody(BaseModel):
...
class CreatePlanItemMarkupsRequestBodyTypedDict(TypedDict):
    ...
    provider_markups: NotRequired[
        Nullable[Dict[str, CreatePlanItemProviderMarkupsRequestBodyTypedDict]]
    ]
    r"""Per-provider markup percentages for customers on this plan."""
    model_markups: NotRequired[
        Nullable[Dict[str, CreatePlanItemModelMarkupsRequestBodyTypedDict]]
    ]
    r"""Per-model markup overrides for customers on this plan."""


class CreatePlanItemMarkupsRequestBody(BaseModel):
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
    ...
    provider_markups: OptionalNullable[
        Dict[str, CreatePlanItemProviderMarkupsRequestBody]
    ] = UNSET
    r"""Per-provider markup percentages for customers on this plan."""

    model_markups: OptionalNullable[
        Dict[str, CreatePlanItemModelMarkupsRequestBody]
    ] = UNSET
    r"""Per-model markup overrides for customers on this plan."""
...
class CreatePlanItemFeatureOverrideRequestBodyTypedDict(TypedDict):
    ...
    markups: NotRequired[CreatePlanItemMarkupsRequestBodyTypedDict]
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class CreatePlanItemFeatureOverrideRequestBody(BaseModel):
    ...
    markups: Optional[CreatePlanItemMarkupsRequestBody] = None
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class CreatePlanItemPlanItemTypedDict(TypedDict):
    ...
    threshold_billing: NotRequired[
        Nullable[CreatePlanItemThresholdBillingRequestBodyTypedDict]
    ]
    ...
    r"""Rollover config for unused units. If set, unused included units carry over."""
    expiry: NotRequired[CreatePlanItemExpiryRequestBodyTypedDict]
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class CreatePlanItemPlanItem(BaseModel):
    ...
    threshold_billing: OptionalNullable[CreatePlanItemThresholdBillingRequestBody] = (
        UNSET
    )
    r"""Bills this many feature units when outstanding overage reaches it."""
    ...
    expiry: Optional[CreatePlanItemExpiryRequestBody] = None
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class FreeTrialRequestBody(BaseModel):
    ...
    on_end: Optional[CreatePlanOnEndRequestBody] = "bill"
    r"""Behavior when the trial ends. 'bill' charges the customer (default). 'revert' expires the trial and restores the customer's previous plan."""
...
CreatePlanAutoTopupIntervalRequestBody = Literal[
    "hour",
    "day",
    "week",
    "month",
...
class CreatePlanItemThresholdBillingResponseTypedDict(TypedDict):
    threshold: float


class CreatePlanItemThresholdBillingResponse(BaseModel):
    threshold: float
