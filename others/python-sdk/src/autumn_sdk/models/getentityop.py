...
GetEntitySubscriptionScope = Union[
    Literal[
        "customer",
        "entity",
    ],
...
class GetEntitySubscriptionTypedDict(TypedDict):
    ...
    scope: NotRequired[GetEntitySubscriptionScope]
    r"""Whether this subscription is attached at the customer level or entity level."""
...
class GetEntitySubscription(BaseModel):
    ...
    scope: Optional[GetEntitySubscriptionScope] = None
    r"""Whether this subscription is attached at the customer level or entity level."""
...
class GetEntityPurchaseTypedDict(TypedDict):
    ...
    plan: NotRequired[PlanTypedDict]
    scope: NotRequired[GetEntityPurchaseScope]
    r"""Whether this purchase is attached at the customer level or entity level."""
...
class GetEntityPurchase(BaseModel):
    ...
    scope: Optional[GetEntityPurchaseScope] = None
    r"""Whether this purchase is attached at the customer level or entity level."""
...
class GetEntityDimensions6TypedDict(TypedDict):
    match: Dict[str, str]
...
class GetEntityDimensions6(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
...
GetEntityDimensionsToEnum3 = Literal["inf",]


GetEntityDimensionsToUnion3TypedDict = TypeAliasType(
    "GetEntityDimensionsToUnion3TypedDict", Union[float, GetEntityDimensionsToEnum3]
)
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


GetEntityDimensionsToUnion3 = TypeAliasType(
    "GetEntityDimensionsToUnion3", Union[float, GetEntityDimensionsToEnum3]
)
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


class GetEntityDimensionsTier3TypedDict(TypedDict):
    to: GetEntityDimensionsToUnion3TypedDict
    r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""
    credit_cost: float
    r"""Credits consumed per billing-unit group within this tier."""


class GetEntityDimensionsTier3(BaseModel):
    to: GetEntityDimensionsToUnion3
    r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""
...
class GetEntityDimensions5TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
    tiers: List[GetEntityDimensionsTier3TypedDict]
    priority: NotRequired[int]
    r"""Breaks ties between dimensions that match the same number of keys. Higher wins."""
    tier_behavior: Literal["graduated"]


class GetEntityDimensions5(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""

    tiers: List[GetEntityDimensionsTier3]
...
GetEntityDimensionsUnion3TypedDict = TypeAliasType(
    "GetEntityDimensionsUnion3TypedDict",
    Union[GetEntityDimensions6TypedDict, GetEntityDimensions5TypedDict],
)


GetEntityDimensionsUnion3 = TypeAliasType(
    "GetEntityDimensionsUnion3", Union[GetEntityDimensions6, GetEntityDimensions5]
)


class GetEntityMultipliers3TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
...
class GetEntityMultipliers3(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
...
class GetEntityCreditSchema3TypedDict(TypedDict):
    credit_cost: float
...
class GetEntityCreditSchema3(BaseModel):
    ...
    dimensions: Optional[Dict[str, GetEntityDimensionsUnion3]] = None
    r"""Named rates chosen by event properties. The most specific match sets the rate; with no match the item's own rate applies."""

    multipliers: Optional[Dict[str, GetEntityMultipliers3]] = None
    r"""Named adjustments chosen by event properties. Every match applies: factors multiply, then adds are summed."""
...
class GetEntityDimensions4TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
    credit_cost: float
    r"""Credits consumed per billing-unit group when this dimension matches."""
...
class GetEntityDimensions4(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
...
GetEntityDimensionsToEnum2 = Literal["inf",]


GetEntityDimensionsToUnion2TypedDict = TypeAliasType(
    "GetEntityDimensionsToUnion2TypedDict", Union[float, GetEntityDimensionsToEnum2]
)
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


GetEntityDimensionsToUnion2 = TypeAliasType(
    "GetEntityDimensionsToUnion2", Union[float, GetEntityDimensionsToEnum2]
)
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


class GetEntityDimensionsTier2TypedDict(TypedDict):
    to: GetEntityDimensionsToUnion2TypedDict
    r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""
    credit_cost: float
    r"""Credits consumed per billing-unit group within this tier."""


class GetEntityDimensionsTier2(BaseModel):
    to: GetEntityDimensionsToUnion2
    r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""
...
class GetEntityDimensions3TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
    tiers: List[GetEntityDimensionsTier2TypedDict]
    priority: NotRequired[int]
    r"""Breaks ties between dimensions that match the same number of keys. Higher wins."""
    tier_behavior: Literal["graduated"]


class GetEntityDimensions3(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""

    tiers: List[GetEntityDimensionsTier2]
...
GetEntityDimensionsUnion2TypedDict = TypeAliasType(
    "GetEntityDimensionsUnion2TypedDict",
    Union[GetEntityDimensions4TypedDict, GetEntityDimensions3TypedDict],
)


GetEntityDimensionsUnion2 = TypeAliasType(
    "GetEntityDimensionsUnion2", Union[GetEntityDimensions4, GetEntityDimensions3]
)


class GetEntityMultipliers2TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
    factor: NotRequired[float]
    r"""Multiplies the matched rate. All matching multipliers stack."""
...
class GetEntityMultipliers2(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
...
class GetEntityCreditSchema2TypedDict(TypedDict):
    ...
    billing_units: NotRequired[float]
    r"""Number of metered-feature units priced together. Defaults to one when omitted."""
    dimensions: NotRequired[Dict[str, GetEntityDimensionsUnion2TypedDict]]
    r"""Named rates chosen by event properties. The most specific match sets the rate; with no match the item's own rate applies."""
    multipliers: NotRequired[Dict[str, GetEntityMultipliers2TypedDict]]
    r"""Named adjustments chosen by event properties. Every match applies: factors multiply, then adds are summed."""


class GetEntityCreditSchema2(BaseModel):
    metered_feature_id: str
    r"""ID of the metered feature that draws from this credit system."""
    ...
    dimensions: Optional[Dict[str, GetEntityDimensionsUnion2]] = None
    r"""Named rates chosen by event properties. The most specific match sets the rate; with no match the item's own rate applies."""

    multipliers: Optional[Dict[str, GetEntityMultipliers2]] = None
    r"""Named adjustments chosen by event properties. Every match applies: factors multiply, then adds are summed."""
...
class GetEntityDimensions2TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
    credit_cost: float
    r"""Credits consumed per billing-unit group when this dimension matches."""
...
class GetEntityDimensions2(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
...
GetEntityDimensionsToEnum1 = Literal["inf",]


GetEntityDimensionsToUnion1TypedDict = TypeAliasType(
    "GetEntityDimensionsToUnion1TypedDict", Union[float, GetEntityDimensionsToEnum1]
)
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


GetEntityDimensionsToUnion1 = TypeAliasType(
    "GetEntityDimensionsToUnion1", Union[float, GetEntityDimensionsToEnum1]
)
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


class GetEntityDimensionsTier1TypedDict(TypedDict):
    to: GetEntityDimensionsToUnion1TypedDict
    r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""
    credit_cost: float
    r"""Credits consumed per billing-unit group within this tier."""


class GetEntityDimensionsTier1(BaseModel):
    to: GetEntityDimensionsToUnion1
    r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""
...
class GetEntityDimensions1TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
    tiers: List[GetEntityDimensionsTier1TypedDict]
    priority: NotRequired[int]
    r"""Breaks ties between dimensions that match the same number of keys. Higher wins."""
    tier_behavior: Literal["graduated"]


class GetEntityDimensions1(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""

    tiers: List[GetEntityDimensionsTier1]
...
GetEntityDimensionsUnion1TypedDict = TypeAliasType(
    "GetEntityDimensionsUnion1TypedDict",
    Union[GetEntityDimensions2TypedDict, GetEntityDimensions1TypedDict],
)


GetEntityDimensionsUnion1 = TypeAliasType(
    "GetEntityDimensionsUnion1", Union[GetEntityDimensions2, GetEntityDimensions1]
)


class GetEntityMultipliers1TypedDict(TypedDict):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
    factor: NotRequired[float]
    r"""Multiplies the matched rate. All matching multipliers stack."""
...
class GetEntityMultipliers1(BaseModel):
    match: Dict[str, str]
    r"""Event properties this entry applies to. Every key must equal the tracked property, compared as strings."""
...
GetEntityToEnum = Literal["inf",]


GetEntityToUnionTypedDict = TypeAliasType(
    "GetEntityToUnionTypedDict", Union[float, GetEntityToEnum]
)
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


GetEntityToUnion = TypeAliasType("GetEntityToUnion", Union[float, GetEntityToEnum])
r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""


class GetEntityTierTypedDict(TypedDict):
    to: GetEntityToUnionTypedDict
    r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""
    credit_cost: float
    r"""Credits consumed per billing-unit group within this tier."""


class GetEntityTier(BaseModel):
    to: GetEntityToUnion
    r"""Inclusive upper usage boundary for this graduated tier. The final tier must be 'inf'."""
...
class GetEntityCreditSchema1TypedDict(TypedDict):
    metered_feature_id: str
    r"""ID of the metered feature that draws from this credit system."""
    tiers: List[GetEntityTierTypedDict]
    billing_units: NotRequired[float]
    r"""Number of metered-feature units priced together. Defaults to one when omitted."""
    dimensions: NotRequired[Dict[str, GetEntityDimensionsUnion1TypedDict]]
    r"""Named rates chosen by event properties. The most specific match sets the rate; with no match the item's own rate applies."""
    multipliers: NotRequired[Dict[str, GetEntityMultipliers1TypedDict]]
    r"""Named adjustments chosen by event properties. Every match applies: factors multiply, then adds are summed."""
    tier_behavior: Literal["graduated"]


class GetEntityCreditSchema1(BaseModel):
    metered_feature_id: str
    r"""ID of the metered feature that draws from this credit system."""

    tiers: List[GetEntityTier]

    billing_units: Optional[float] = None
    r"""Number of metered-feature units priced together. Defaults to one when omitted."""

    dimensions: Optional[Dict[str, GetEntityDimensionsUnion1]] = None
    r"""Named rates chosen by event properties. The most specific match sets the rate; with no match the item's own rate applies."""

    multipliers: Optional[Dict[str, GetEntityMultipliers1]] = None
    r"""Named adjustments chosen by event properties. Every match applies: factors multiply, then adds are summed."""
...
GetEntityCreditSchemaUnionTypedDict = TypeAliasType(
...
GetEntityCreditSchemaUnion = TypeAliasType(
    "GetEntityCreditSchemaUnion",
    Union[GetEntityCreditSchema2, GetEntityCreditSchema3, GetEntityCreditSchema1],
)
...
class GetEntityStripeTypedDict(TypedDict):
...
class GetEntityStripe(BaseModel):
...
class GetEntityProcessorsTypedDict(TypedDict):
    r"""Processor mappings for this feature. Present when a Stripe product or meter is set."""

    stripe: NotRequired[GetEntityStripeTypedDict]


class GetEntityProcessors(BaseModel):
    r"""Processor mappings for this feature. Present when a Stripe product or meter is set."""

    stripe: Optional[GetEntityStripe] = None
...
class GetEntityFeatureTypedDict(TypedDict):
    ...
    credit_schema: NotRequired[List[GetEntityCreditSchemaUnionTypedDict]]
    ...
    r"""Display names for the feature in billing UI and customer-facing components."""
    processors: NotRequired[GetEntityProcessorsTypedDict]
    r"""Processor mappings for this feature. Present when a Stripe product or meter is set."""
...
class GetEntityFeature(BaseModel):
    ...
    credit_schema: Optional[List[GetEntityCreditSchemaUnion]] = None
    r"""For classic credit systems: maps metered features to flat or graduated credit costs."""
    ...
    processors: Optional[GetEntityProcessors] = None
    r"""Processor mappings for this feature. Present when a Stripe product or meter is set."""
...
GetEntitySpendLimitSource = Union[
    Literal[
        "customer",
        "plan",
    ],
...
class GetEntitySpendLimitTypedDict(TypedDict):
    ...
    limit_type: NotRequired[GetEntityLimitType]
    r"""How overage_limit is interpreted: an absolute overage cap (default) or a percentage of the main-plan allowance."""
    ...
    source: NotRequired[GetEntitySpendLimitSource]
    r"""Response-only: whether the entry is a customer-level override or inherited from an attached plan's defaults."""
...
class GetEntitySpendLimit(BaseModel):
    ...
    limit_type: Optional[GetEntityLimitType] = None
    r"""How overage_limit is interpreted: an absolute overage cap (default) or a percentage of the main-plan allowance."""
    ...
    source: Optional[GetEntitySpendLimitSource] = None
    r"""Response-only: whether the entry is a customer-level override or inherited from an attached plan's defaults."""
...
class GetEntityUsageLimitFilterTypedDict(TypedDict):
...
class GetEntityUsageLimitFilter(BaseModel):
    r"""When set, only usage from events whose properties match counts toward this cap. Omit to count all usage of the feature."""

    properties: Dict[str, str]


GetEntityUsageLimitSource = Union[
    Literal[
        "customer",
        "plan",
    ],
...
class GetEntityUsageLimitTypedDict(TypedDict):
    ...
    r"""Window alignment. 'billing_cycle' phases the interval to the customer's renewal time; 'utc' aligns to the UTC calendar."""
    filter_: NotRequired[GetEntityUsageLimitFilterTypedDict]
    r"""When set, only usage from events whose properties match counts toward this cap. Omit to count all usage of the feature."""
    ...
    source: NotRequired[GetEntityUsageLimitSource]
    r"""Response-only: whether the entry is a customer-level override or inherited from an attached plan's defaults."""
...
class GetEntityUsageLimit(BaseModel):
    ...
    filter_: Annotated[
        Optional[GetEntityUsageLimitFilter], pydantic.Field(alias="filter")
    ] = None
    r"""When set, only usage from events whose properties match counts toward this cap. Omit to count all usage of the feature."""
    ...
    source: Optional[GetEntityUsageLimitSource] = None
    r"""Response-only: whether the entry is a customer-level override or inherited from an attached plan's defaults."""
...
class GetEntityUsageAlertFilterTypedDict(TypedDict):
    r"""Only valid with basis usage_limit. Points the alert at the usage limit carrying the same filter."""

    properties: Dict[str, str]


class GetEntityUsageAlertFilter(BaseModel):
    r"""Only valid with basis usage_limit. Points the alert at the usage limit carrying the same filter."""

    properties: Dict[str, str]


GetEntityUsageAlertSource = Union[
    Literal[
        "customer",
        "plan",
    ],
...
class GetEntityUsageAlertTypedDict(TypedDict):
    ...
    basis: NotRequired[GetEntityBasis]
    r"""What 100% means. balance: every grant on the feature. included: the plan allowance only. recurring: grants that reset. usage_limit: the cap of the usage limit with the same feature and filter."""
    filter_: NotRequired[GetEntityUsageAlertFilterTypedDict]
    r"""Only valid with basis usage_limit. Points the alert at the usage limit carrying the same filter."""
    name: NotRequired[str]
    r"""Optional user-defined label to distinguish multiple alerts on the same feature."""
    source: NotRequired[GetEntityUsageAlertSource]
    r"""Response-only: whether the entry is a customer-level override or inherited from an attached plan's defaults."""
...
class GetEntityUsageAlert(BaseModel):
    ...
    basis: Optional[GetEntityBasis] = "balance"
    r"""What 100% means. balance: every grant on the feature. included: the plan allowance only. recurring: grants that reset. usage_limit: the cap of the usage limit with the same feature and filter."""

    filter_: Annotated[
        Optional[GetEntityUsageAlertFilter], pydantic.Field(alias="filter")
    ] = None
    r"""Only valid with basis usage_limit. Points the alert at the usage limit carrying the same filter."""
    ...
    source: Optional[GetEntityUsageAlertSource] = None
    r"""Response-only: whether the entry is a customer-level override or inherited from an attached plan's defaults."""
...
GetEntityOverageAllowedSource = Union[
    Literal[
        "customer",
        "plan",
    ],
...
class GetEntityOverageAllowedTypedDict(TypedDict):
    ...
    source: NotRequired[GetEntityOverageAllowedSource]
    r"""Response-only: whether the entry is a customer-level override or inherited from an attached plan's defaults."""
...
class GetEntityOverageAllowed(BaseModel):
    ...
    source: Optional[GetEntityOverageAllowedSource] = None
    r"""Response-only: whether the entry is a customer-level override or inherited from an attached plan's defaults."""
...
class GetEntityInvoiceTypedDict(TypedDict):
    ...
    processor_type: NotRequired[GetEntityProcessorType]
    r"""The billing processor that owns this invoice."""
...
class GetEntityInvoice(BaseModel):
    ...
    processor_type: Optional[GetEntityProcessorType] = "stripe"
    r"""The billing processor that owns this invoice."""
...
try:
    GetEntityDimensions5.model_rebuild()
except NameError:
    pass
try:
    GetEntityCreditSchema3.model_rebuild()
except NameError:
    pass
try:
    GetEntityDimensions3.model_rebuild()
except NameError:
    pass
try:
    GetEntityDimensions1.model_rebuild()
except NameError:
    pass
try:
    GetEntityCreditSchema1.model_rebuild()
except NameError:
    pass
try:
    GetEntityUsageLimit.model_rebuild()
except NameError:
    pass
try:
    GetEntityUsageAlert.model_rebuild()
except NameError:
    pass
