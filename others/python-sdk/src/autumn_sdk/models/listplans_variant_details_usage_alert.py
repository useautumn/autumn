...
class ListPlansItemThresholdBillingTypedDict(TypedDict):
    threshold: float


class ListPlansItemThresholdBilling(BaseModel):
    threshold: float
...
class ListPlansItemExpiryTypedDict(TypedDict):
    duration: ListPlansItemDuration
    length: float


class ListPlansItemExpiry(BaseModel):
    duration: ListPlansItemDuration
...
class ListPlansItemProviderMarkupsTypedDict(TypedDict):
    markup: float


class ListPlansItemProviderMarkups(BaseModel):
    markup: float


class ListPlansItemModelMarkupsTypedDict(TypedDict):
    markup: NotRequired[float]
    input_cost: NotRequired[float]
    output_cost: NotRequired[float]


class ListPlansItemModelMarkups(BaseModel):
...
class ListPlansItemMarkupsTypedDict(TypedDict):
    ...
    provider_markups: NotRequired[
        Nullable[Dict[str, ListPlansItemProviderMarkupsTypedDict]]
    ]
    r"""Per-provider markup percentages for customers on this plan."""
    model_markups: NotRequired[Nullable[Dict[str, ListPlansItemModelMarkupsTypedDict]]]
    r"""Per-model markup overrides for customers on this plan."""


class ListPlansItemMarkups(BaseModel):
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""

    default_markup: Optional[float] = None
    r"""Default percentage markup for customers on this plan. Use -100 to make usage free."""

    provider_markups: OptionalNullable[Dict[str, ListPlansItemProviderMarkups]] = UNSET
    r"""Per-provider markup percentages for customers on this plan."""

    model_markups: OptionalNullable[Dict[str, ListPlansItemModelMarkups]] = UNSET
    r"""Per-model markup overrides for customers on this plan."""
...
class ListPlansItemFeatureOverrideTypedDict(TypedDict):
    ...
    markups: NotRequired[ListPlansItemMarkupsTypedDict]
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class ListPlansItemFeatureOverride(BaseModel):
    ...
    markups: Optional[ListPlansItemMarkups] = None
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class ListPlansItemTypedDict(TypedDict):
    ...
    threshold_billing: NotRequired[Nullable[ListPlansItemThresholdBillingTypedDict]]
    ...
    r"""Rollover configuration for unused units. If set, unused included units roll over to the next period."""
    expiry: NotRequired[Nullable[ListPlansItemExpiryTypedDict]]
...
class ListPlansItem(BaseModel):
    ...
    threshold_billing: OptionalNullable[ListPlansItemThresholdBilling] = UNSET
    r"""Bills this many feature units when outstanding overage reaches it."""
    ...
    expiry: OptionalNullable[ListPlansItemExpiry] = UNSET
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
ListPlansAutoTopupInterval = Union[
    Literal[
        "hour",
        "day",
        "week",
...
class ListPlansVariantDetailsThresholdBillingTypedDict(TypedDict):
    threshold: float


class ListPlansVariantDetailsThresholdBilling(BaseModel):
    threshold: float
...
ListPlansVariantDetailsDuration = Union[
    Literal[
        "day",
        "week",
        "month",
...
class ListPlansVariantDetailsExpiryTypedDict(TypedDict):
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class ListPlansVariantDetailsExpiry(BaseModel):
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class ListPlansVariantDetailsProviderMarkupsTypedDict(TypedDict):
    markup: float


class ListPlansVariantDetailsProviderMarkups(BaseModel):
    markup: float


class ListPlansVariantDetailsModelMarkupsTypedDict(TypedDict):
    markup: NotRequired[float]
    input_cost: NotRequired[float]
    output_cost: NotRequired[float]


class ListPlansVariantDetailsModelMarkups(BaseModel):
    markup: Optional[float] = None
...
class ListPlansVariantDetailsMarkupsTypedDict(TypedDict):
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""

    default_markup: NotRequired[float]
    r"""Default percentage markup for customers on this plan. Use -100 to make usage free."""
    provider_markups: NotRequired[
        Nullable[Dict[str, ListPlansVariantDetailsProviderMarkupsTypedDict]]
    ]
    r"""Per-provider markup percentages for customers on this plan."""
    model_markups: NotRequired[
        Nullable[Dict[str, ListPlansVariantDetailsModelMarkupsTypedDict]]
    ]
    r"""Per-model markup overrides for customers on this plan."""


class ListPlansVariantDetailsMarkups(BaseModel):
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
    ...
    provider_markups: OptionalNullable[
        Dict[str, ListPlansVariantDetailsProviderMarkups]
    ] = UNSET
    r"""Per-provider markup percentages for customers on this plan."""

    model_markups: OptionalNullable[Dict[str, ListPlansVariantDetailsModelMarkups]] = (
        UNSET
    )
    r"""Per-model markup overrides for customers on this plan."""
...
class ListPlansVariantDetailsFeatureOverrideTypedDict(TypedDict):
    ...
    r"""For credit system features: replaces the feature's credit_schema entirely for customers on this plan."""
    markups: NotRequired[ListPlansVariantDetailsMarkupsTypedDict]
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class ListPlansVariantDetailsFeatureOverride(BaseModel):
    ...
    markups: Optional[ListPlansVariantDetailsMarkups] = None
    r"""For AI credit system features: replaces the feature's markup chain entirely for customers on this plan. An unset level means no markup at that level rather than inheriting the feature's."""
...
class ListPlansVariantDetailsPlanItemTypedDict(TypedDict):
    ...
    threshold_billing: NotRequired[
        Nullable[ListPlansVariantDetailsThresholdBillingTypedDict]
    ]
    r"""Bills this many feature units when outstanding overage reaches it."""
    ...
    r"""Rollover config for unused units. If set, unused included units carry over."""
    expiry: NotRequired[ListPlansVariantDetailsExpiryTypedDict]
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class ListPlansVariantDetailsPlanItem(BaseModel):
    ...
    threshold_billing: OptionalNullable[ListPlansVariantDetailsThresholdBilling] = UNSET
    r"""Bills this many feature units when outstanding overage reaches it."""
    ...
    expiry: Optional[ListPlansVariantDetailsExpiry] = None
    r"""Purchased units expire this long after each purchase. One-off prepaid consumable items only."""
...
class ListPlansVariantDetailsFreeTrialParams(BaseModel):
    ...
    on_end: Optional[ListPlansVariantDetailsOnEnd] = "bill"
    r"""Behavior when the trial ends. 'bill' charges the customer (default). 'revert' expires the trial and restores the customer's previous plan."""
...
ListPlansVariantDetailsAutoTopupInterval = Union[
    Literal[
        "hour",
        "day",
        "week",
