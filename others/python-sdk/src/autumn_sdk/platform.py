...
class Platform(BaseSDK):
    def get_stripe_connection(
        ...
        *,
        ...
        env: models.GetStripeConnectionEnv,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.GetStripeConnectionResponse:
        r"""Read a managed organization's Stripe OAuth connection, account ID, and authorization time in the selected environment.

        :param organization_slug: Public tenant organization slug, without the master organization suffix.
        :param env: Stripe connection environment to inspect or disconnect.
        ...
        req = self._build_request(
            ...
            _globals=models.GetStripeConnectionGlobals(
                x_api_version=self.sdk_configuration.globals.x_api_version,
            ),
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.GetStripeConnectionParams
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="getStripeConnection",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.GetStripeConnectionResponse, http_res)
    ...
    async def get_stripe_connection_async(
        self,
        *,
        organization_slug: str,
        env: models.GetStripeConnectionEnv,
    ...
    def disconnect_stripe(
        ...
        *,
        organization_slug: str,
        env: models.DisconnectStripeEnv,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.DisconnectStripeResponse:
        r"""Revoke Autumn's Stripe OAuth access for a managed organization in the selected environment. Does not delete the Stripe account or cancel subscriptions.
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.DisconnectStripeGlobals(
                x_api_version=self.sdk_configuration.globals.x_api_version,
            ),
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.DisconnectStripeParams
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.DisconnectStripeResponse, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise errors.AutumnDefaultError(
                "API error occurred", http_res, http_res_text
    ...
    async def disconnect_stripe_async(
        self,
        *,
        organization_slug: str,
        env: models.DisconnectStripeEnv,
