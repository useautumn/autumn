...
test.concurrent(
	`${chalk.yellowBright("license attach immediate switch: quarterly Pro upgrades to annual with annual seats")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("license transitions: plan switch pairs seats 1:1 by license plan group")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("license transitions: ambiguous group match with active assignments blocks the switch")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("license transitions: unused pools never block an ambiguous or dropped switch")}`,
	async () => {
