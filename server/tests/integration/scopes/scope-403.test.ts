...
const ROUTES = [
	...
	{
		handlerName: "handleAdvanceTestClock",
		handlerFile: "src/internal/customers/handlers/handleAdvanceTestClock.ts",
		method: "POST",
		path: "/v1/customers.advance_test_clock",
		style: "RPC",
		group: "v1/customers",
		mountChain: ["/v1", "", "", "/customers.advance_test_clock"],
		sourceRouterFile: "src/internal/customers/cusRouter.ts",
		routeKind: "createRoute",
		needsScopes: true,
		isWebhookExempt: false,
	...
	{
		handlerName: "handleLegacyAdvanceTestClock",
		handlerFile:
			"src/internal/billing/v2/handlers/handleLegacyAdvanceTestClock.ts",
		method: "POST",
		path: "/v1/billing.advance_test_clock",
		style: "RPC",
		group: "v1/billing",
		mountChain: ["/v1", "", "", "/billing.advance_test_clock"],
		sourceRouterFile: "src/internal/billing/billingRouter.ts",
		routeKind: "createRoute",
		needsScopes: true,
		isWebhookExempt: false,
...
> = {
	...
	"POST|/v1/customers.advance_test_clock|handleAdvanceTestClock": {
		decision: "decided",
		scopes: ["customers:write"],
		shape: "array",
		note: "test clocks are a customer concern; the CLI only mints customers:*",
		decidedAt: "2026-09-21T00:00:00.000Z",
	},
	"POST|/v1/billing.advance_test_clock|handleLegacyAdvanceTestClock": {
		decision: "decided",
		scopes: ["customers:write", "billing:write"],
		shape: "any",
		note: "deprecated alias; billing:write kept for keys minted before the move",
		decidedAt: "2026-09-21T00:00:00.000Z",
	},
