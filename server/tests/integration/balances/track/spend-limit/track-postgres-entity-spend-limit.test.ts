...
test.concurrent(
	`${chalk.yellowBright("track-postgres-entity-spend-limit1: per-entity messages cap overage across Redis then Postgres track paths")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("track-postgres-entity-spend-limit2: entity-product messages cap overage across Redis then Postgres track paths")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("track-postgres-entity-spend-limit3: credit-system overage stays capped when Postgres handles the second track")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("track-postgres-entity-spend-limit4: prepaid + consumable credits stay capped when Postgres handles the second track")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("track-postgres-entity-spend-limit5: concurrent entity-product messages respect spend limit in Postgres path")}`,
	async () => {
		const entityProduct = products.base({
