 ...
 *
 * Slice 1 of 2 (see legacy-attach-invoice-mode-2.test.ts for slice 2).
 *
 ...
 */
test.concurrent(
	`${chalk.yellowBright("legacy-inv-mode 1: new subscription")}`,
	async () => {
 ...
 */
test.concurrent(
	`${chalk.yellowBright("legacy-inv-mode 2: merged add-on")}`,
	async () => {
