 ...
 *
 * Slice 1/2: the cases that run on the org's DEFAULT transition rules. The
 * org-rule case (6) lives in the -2 sibling because it mutates org config.
 *
 ...
 * see fresh balances) and floors allocated carries at zero (5).
...
// ═══════════════════════════════════════════════════════════════════════════
test.concurrent(
	`${chalk.yellowBright("sub.updated auto-sync carry 1: upgrade carries consumable usage")}`,
	async () => {
...
// ═══════════════════════════════════════════════════════════════════════════
test.concurrent(
	`${chalk.yellowBright("sub.updated auto-sync carry 2: upgrade offsets existing overage")}`,
	async () => {
...
// ═══════════════════════════════════════════════════════════════════════════
test.concurrent(
	`${chalk.yellowBright("sub.updated auto-sync carry 3: remaining overage persists past upgrade")}`,
	async () => {
...
// ═══════════════════════════════════════════════════════════════════════════
test.concurrent(
	`${chalk.yellowBright("sub.updated auto-sync carry 4: downgrade carries usage into overage")}`,
	async () => {
...
// ═══════════════════════════════════════════════════════════════════════════
test.concurrent(
	`${chalk.yellowBright("sub.updated auto-sync carry 5: allocated usage never changes, balance goes negative")}`,
	async () => {
...
// ═══════════════════════════════════════════════════════════════════════════
test.concurrent(
	`${chalk.yellowBright("sub.created auto-sync carry 7: default free usage carries onto synced paid plan")}`,
	async () => {
