/**
 * Invoice Created Webhook Tests - Per-Entity Consumable Prices (Basic)
 *
 * Tests for handling the `invoice.created` Stripe webhook event for per-entity
 * consumable (usage-in-arrear) prices. Covers basic overage scenarios:
 * multiple entities with varying overage, billing units rounding, and mixed usage.
 */
