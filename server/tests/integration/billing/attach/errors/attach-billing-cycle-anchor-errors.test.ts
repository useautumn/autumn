...
test.concurrent(
	`${chalk.yellowBright("attach-billing-cycle-anchor-errors 1: scheduled downgrade with reset is blocked")}`,
	async () => {
...
test(`${chalk.yellowBright("attach-billing-cycle-anchor-errors 2: past timestamp is blocked")}`, async () => {
...
test.concurrent(
	`${chalk.yellowBright("attach-billing-cycle-anchor-errors 3: anchor with trial is blocked")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("attach-billing-cycle-anchor-errors 4: anchor on one-off product is blocked")}`,
	async () => {
