 ...
 *
 * Slice 1 of 2 (see attach-invoice-draft-deferred-2.test.ts for slice 2).
 *
...
import type { ApiCustomerV3, AttachParamsV0 } from "@autumn/shared";
 ...
 */
test.concurrent(
	`${chalk.yellowBright("attach-invoice-draft-def 1: new plan")}`,
	async () => {
 ...
 */
test.concurrent(
	`${chalk.yellowBright("attach-invoice-draft-def 2: upgrade")}`,
	async () => {
