...
test(`${chalk.yellowBright("billing-cycle-anchor-new-plan-entities 1: ent2 free -> pro, scheduled anchor")}`, async () => {
...
test(`${chalk.yellowBright("billing-cycle-anchor-new-plan-entities 2: ent2 no plan -> pro, scheduled anchor")}`, async () => {
...
test.concurrent(
	`${chalk.yellowBright("billing-cycle-anchor-new-plan-entities 3: ent2 free -> pro, anchor now")}`,
	async () => {
