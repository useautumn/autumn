...
test.concurrent(
	`${chalk.yellowBright("create: minimal plan (id + name only)")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("create: with description field")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("create: boolean feature")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("create: add_on and auto_enable flags")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("create: monthly base price")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("create: yearly base price")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("create: full SaaS plan with multiple feature types")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("create: usage-only product (no base price)")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("create: metered feature with rollover")}`,
	async () => {
...
test.concurrent(
	`${chalk.yellowBright("create: enterprise plan with all features")}`,
	async () => {
