...
const realEdgeConfigRegistry = {
	...(await import("@/internal/misc/edgeConfigs/edgeConfigRegistry.js")),
};
const realQueueUtils = { ...(await import("@/queue/queueUtils.js")) };

mock.module("@/internal/misc/edgeConfigs/edgeConfigRegistry.js", () => ({
...
const { _setBatchResetConfigForTesting } = await import(
	"@/internal/misc/edgeConfigs/batchReset/batchResetConfigStore.js"
);
