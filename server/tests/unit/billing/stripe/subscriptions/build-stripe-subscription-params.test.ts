...
const UPDATE_USER_VALUES: Record<
...
const CANCEL_USER_VALUES: Record<
...
const updateKeys = Object.keys(SUBSCRIPTION_UPDATE_KEY_POLICY) as Array<
	keyof Stripe.SubscriptionUpdateParams
>;

const cancelKeys = Object.keys(SUBSCRIPTION_CANCEL_KEY_POLICY) as Array<
	keyof Stripe.SubscriptionCancelParams
>;
