...
export const coreUpdateSubscription: TestGroup = {
	...
	paths: [
		...
		"billing/update-subscription/cancel/end-of-cycle/cancel-end-of-cycle-2.test.ts",
		"billing/update-subscription/cancel/end-of-cycle/cancel-end-of-cycle-addon.test.ts",
		"billing/update-subscription/cancel/end-of-cycle/cancel-end-of-cycle-addon-3.test.ts",
		"billing/update-subscription/cancel/end-of-cycle/cancel-end-of-cycle-addon-2.test.ts",
		"billing/update-subscription/cancel/immediately/cancel-immediately.test.ts",
		"billing/update-subscription/cancel/immediately/cancel-immediately-2.test.ts",
		...
		"billing/update-subscription/custom-plan/update-paid-basic-3.test.ts",
		"billing/update-subscription/custom-plan/update-paid-basic-2.test.ts",
		...
		"billing/update-subscription/custom-plan/update-paid-prepaid-3.test.ts",
		"billing/update-subscription/custom-plan/update-paid-prepaid-2.test.ts",
		...
		"billing/update-subscription/free-trial/update-paid-trials-2.test.ts",
		...
		"billing/update-subscription/billing-behavior/next-cycle-only-2.test.ts",
		...
		"billing/update-subscription/params/recalculate-balances/update-quantity-prepaid-overage-2.test.ts",
	],
};
