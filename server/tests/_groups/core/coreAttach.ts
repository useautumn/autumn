...
export const coreAttach: TestGroup = {
	...
	paths: [
		...
		"billing/attach/immediate-switch/paid-features/immediate-switch-prepaid.test.ts",
		"billing/attach/immediate-switch/paid-features/immediate-switch-consumable.test.ts",
		"billing/attach/immediate-switch/entities/immediate-switch-entities.test.ts",
