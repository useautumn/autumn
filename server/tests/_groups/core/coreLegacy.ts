...
export const coreLegacy: TestGroup = {
	...
	paths: [
		...
		"legacy/attach/attach-new-billing-subscription-2.test.ts",
		"legacy/attach/attach-response.test.ts",
		"legacy/attach/attach-response-2.test.ts",
		"legacy/attach/addon/legacy-addon.test.ts",
		"legacy/attach/checkout/legacy-checkout-basic.test.ts",
		"legacy/attach/checkout/legacy-checkout-basic-2.test.ts",
		"legacy/attach/downgrade/legacy-downgrade.test.ts",
		"legacy/attach/downgrade/legacy-downgrade-3.test.ts",
		"legacy/attach/downgrade/legacy-downgrade-2.test.ts",
		"legacy/attach/entities/legacy-entities-basic.test.ts",
		"legacy/attach/entities/legacy-entities-basic-2.test.ts",
		"legacy/attach/invoice/legacy-attach-invoice-mode.test.ts",
		"legacy/attach/invoice/legacy-attach-invoice-mode-2.test.ts",
		"legacy/attach/invoice/payment-failure/legacy-attach-payment-failed.test.ts",
		"legacy/attach/invoice/payment-failure/legacy-attach-payment-failed-2.test.ts",
		...
		"legacy/attach/trial/legacy-trial-3.test.ts",
		"legacy/attach/trial/legacy-trial-2.test.ts",
		"legacy/attach/update-quantity/legacy-update-quantity.test.ts",
		"legacy/attach/update-quantity/legacy-update-quantity-3.test.ts",
		"legacy/attach/update-quantity/legacy-update-quantity-2.test.ts",
		"legacy/attach/upgrade/legacy-upgrade.test.ts",
		"legacy/attach/upgrade/legacy-upgrade-usage.test.ts",
		"legacy/attach/upgrade/legacy-upgrade-usage-2.test.ts",
		"legacy/attach/upgrade/legacy-upgrade-prepaid.test.ts",
		"legacy/attach/upgrade/legacy-upgrade-prepaid-2.test.ts",
		"legacy/attach/upgrade/legacy-upgrade-merged.test.ts",
		"legacy/attach/upgrade/legacy-upgrade-merged-2.test.ts",
	],
};
