...
const activeTempPaths: string[] = [
	...
	// Reproduced: free plan activates, but tracking captures active -> active instead of scheduled -> active.
	// The resulting "updated" webhook cannot satisfy the expected "activated" change; server fix deferred.
