...
import { updateFeatureBalance } from "../utils/cusProductUtils/updateCusEntBalance.js";
...
const testCase = "get-cus-feature2";

describe(`${chalk.yellowBright("get-cus-feature2: testing arrear feature")}`, () => {
