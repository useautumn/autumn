...
describe(`${chalk.yellowBright(
	...
	describe("Create customer -- check free is active", () => {
		it("GET /customers/:id -- checking default product & entitlements", async () => {
		...
		it("GET /entitled -- metered1", async () => {
		...
		it("GET /entitled -- boolean1", async () => {
	...
	describe("Attach pro -- check products & entitlements", () => {
		it("POST /attach -- attaching pro (force checkout)", async () => {
		...
		it("GET /customers/:id -- checking product & entitlements (pro)", async () => {
		...
		it("GET /entitled -- checking entitlements for metered1 && boolean1", async () => {
	...
	describe("One time add on (force checkout)", () => {
		...
		it("POST /attach -- attaching one time add on (force checkout) [no quantity passed in]", async () => {
			try {
		...
		it("GET /customers/:id -- checking product & entitlements (one time add on)", async () => {
		...
		it("GET /entitled -- checking entitled for metered1", async () => {
			const res: any = await AutumnCli.entitled(
				customerId,
				features.metered1.id,
			);
	...
	describe("Monthly add on", () => {
		it("POST /attach -- attaching monthly add on", async () => {
		...
		it("GET /customers/:id -- checking product & entitlements (monthly add on)", async () => {
			const cusRes = await AutumnCli.getCustomer(customerId);
		...
		it("GET /entitled -- checking entitlements (monthly add on)", async () => {
			const res: any = await AutumnCli.entitled(
				customerId,
				features.metered1.id,
			);
