...
describe(chalk.yellowBright("Pro entitlements"), () => {
	const customerId = "alex-pro-customer";
	...
	it("should upgrade to Pro after calling /attach", async () => {
	...
	it("should run event sending and check balances for each entitlement", async () => {
