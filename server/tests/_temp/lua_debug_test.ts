import { DEDUCT_FROM_CUSTOMER_ENTITLEMENTS_SCRIPT } from "../../src/_luaScriptsV2/luaScriptsV2.js";
...
console.log(
	"  - pay-per-use: balance=-100 (usage_allowed=true, already in overage)",
);
console.log(
	"Expected: Deduct 150 from lifetime → lifetime balance=50, pay-per-use unchanged",
);
