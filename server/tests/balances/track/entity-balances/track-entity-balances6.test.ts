...
const testCase = "track-entity-balances6";

describe(`${chalk.yellowBright(`${testCase}: per-entity overage billing`)}`, () => {
	...
	const user1 = `${testCase}-user1`;
	const user2 = `${testCase}-user2`;
