...
const testCase = "track-allocated4";
...
describe(`${chalk.yellowBright(
	`track-allocated4: Concurrent tracking of consumable + allocated feature at entity / customer level`,
)}`, () => {
	const autumnV1: AutumnInt = new AutumnInt({ version: ApiVersion.V1_2 });

	const entity1Id = "track-allocated4-user-1";
	const entity2Id = "track-allocated4-user-2";
...
`);
  ...
  Entity2: ${numEntity2Messages} messages, ${numEntity2Workflows} workflows`);
		...
		const expectedCustomerTotalWorkflows =
