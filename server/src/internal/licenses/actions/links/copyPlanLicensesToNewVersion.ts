...
export const validateCopiedPlanLicenses = async ({
	...
	planLicenseRows.forEach((row, index) => {
...
/** Copies the previous version's catalog license links onto the new version.
 * Assumes validateCopiedPlanLicenses already passed. */
