...
import { handleDiffCatalogV2 } from "./handlers/handleDiffCatalogV2.js";
import { handleGetCatalogV2 } from "./handlers/handleGetCatalogV2.js";
...
catalogV2RpcRouter.post("/catalogV2.get", ...handleGetCatalogV2);
catalogV2RpcRouter.post("/catalogV2.diff", ...handleDiffCatalogV2);
