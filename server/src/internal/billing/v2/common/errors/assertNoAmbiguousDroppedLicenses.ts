...
import type { UnmatchedOutgoingCustomerLicense } from "@/internal/billing/v2/compute/customerLicenseTransitions/matchCustomerLicenseSuccessors.js";
...
export const assertNoAmbiguousDroppedLicenses = ({
	unmatched,
}: {
